...
from .queries import obtener_velocimetro_v11_tamizaje_gestante, obtener_grafico_mensual_v11_tamizaje_gestante, obtener_variables_v11_tamizaje_gestante, obtener_variables_detallado_v11_tamizaje_gestante, obtener_grafico_por_redes_v11_tamizaje_gestante
from .queries import obtener_grafico_por_microredes_v11_tamizaje_gestante, obtener_grafico_por_establecimientos_v11_tamizaje_gestante
from .queries import obtener_seguimiento_v11_tamizaje_gestante
...
######################################
## VELOCIMETRO
def process_velocimetro_v11_tamizaje_gestante(resultados_velocimetro_v11_tamizaje_gestante: List[Dict]) -> Dict[str, List]:
    """
    ...
    """
    # Validar entrada
    if not resultados_velocimetro_v11_tamizaje_gestante or len(resultados_velocimetro_v11_tamizaje_gestante) == 0:
    ...
    row = resultados_velocimetro_v11_tamizaje_gestante[0]
...
def obtener_resumen_indicador_v11_tamizaje_gestante(anio, mes_inicio, mes_fin, red, microred, establecimiento, provincia=None, distrito=None):
    """
    Obtiene un resumen detallado del indicador 
    """
    datos_base = obtener_velocimetro_v11_tamizaje_gestante(anio, mes_inicio, mes_fin, red, microred, establecimiento, provincia, distrito)
...
def process_avance_mensual_v11_tamizaje_gestante(resultados_avance_mensual_v11_tamizaje_gestante: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_avance_mensual_v11_tamizaje_gestante):
        try:
...
## GRAFICO VARIABLES 
def process_variables_v11_tamizaje_gestante(resultados_variables_v11_tamizaje_gestante: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_variables_v11_tamizaje_gestante):
        try:
            # Verifica que el diccionario tenga las claves necesarias
            required_keys = {'den_variable','num_variable','avance_num_variable'}
            ...
            num_variable = row['num_variable']
            avance_num_variable = row['avance_num_variable']
            
            # Agrega los valores a la lista
            data['den_variable'].append(den_variable)
            data['num_variable'].append(num_variable)
            data['avance_num_variable'].append(avance_num_variable)
...
def process_variables_detallado_v11_tamizaje_gestante(resultados_variables_detallado_v11_tamizaje_gestante: List[Dict]) -> Dict[str, List]:
    ...
    data = {
        ...
        'd_den_variable': [],
        'd_num_variable': [], 
        'd_avance_num_variable': [] # Numerador del indicador principal
    }
    for index, row in enumerate(resultados_variables_detallado_v11_tamizaje_gestante):
        try:
            # Verifica que el diccionario tenga las claves necesarias
            ...
            'd_den_variable','d_num_variable','d_avance_num_variable'}
            ...
            d_avance_num_variable = row['d_avance_num_variable']
            ...
            data['d_avance_num_variable'].append(d_avance_num_variable)
...
def process_grafico_por_redes_v11_tamizaje_gestante(resultados_grafico_por_redes_v11_tamizaje_gestante: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_grafico_por_redes_v11_tamizaje_gestante):
        try:
            # Verifica que el diccionario tenga las claves necesarias
...
def process_grafico_por_microredes_v11_tamizaje_gestante(resultados_grafico_por_microredes_v11_tamizaje_gestante: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_grafico_por_microredes_v11_tamizaje_gestante):
        try:
            # Verifica que el diccionario tenga las claves necesarias
...
def process_grafico_por_establecimientos_v11_tamizaje_gestante(resultados_grafico_por_establecimientos_v11_tamizaje_gestante: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_grafico_por_establecimientos_v11_tamizaje_gestante):
        try:
            # Verifica que el diccionario tenga las claves necesarias
...
def index_v11_tamizaje_gestante(request):
    """
    ...
    if request.headers.get('x-requested-with') == 'XMLHttpRequest':
        try:
            ...
            resultados_velocimetro_v11_tamizaje_gestante = obtener_velocimetro_v11_tamizaje_gestante(
                anio=anio,
            ...
            resumen_v11_tamizaje_gestante = obtener_resumen_indicador_v11_tamizaje_gestante(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,
                mes_fin=mes_seleccionado_fin,
                red=red_seleccionada,
            ...
            resultados_grafico_mensual_v11_tamizaje_gestante = obtener_grafico_mensual_v11_tamizaje_gestante(
                anio=anio,
            ...
            resultados_variables_v11_tamizaje_gestante = obtener_variables_v11_tamizaje_gestante(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,
            ...
            resultados_variables_detallado_v11_tamizaje_gestante = obtener_variables_detallado_v11_tamizaje_gestante(
                anio=anio,
            ...
            resultados_grafico_por_redes_v11_tamizaje_gestante = obtener_grafico_por_redes_v11_tamizaje_gestante(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,  # Usa el mes de inicio seleccionado
                mes_fin=mes_seleccionado_fin,        # Usa el mes de fin seleccionado
                red=red_seleccionada,
            ...
            resultados_grafico_por_microredes_v11_tamizaje_gestante = obtener_grafico_por_microredes_v11_tamizaje_gestante(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,  # Usa el mes de inicio seleccionado
                mes_fin=mes_seleccionado_fin,        # Usa el mes de fin seleccionado
                red=red_seleccionada,
            ...
            resultados_grafico_por_establecimientos_v11_tamizaje_gestante = obtener_grafico_por_establecimientos_v11_tamizaje_gestante(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,  # Usa el mes de inicio seleccionado
                mes_fin=mes_seleccionado_fin,        # Usa el mes de fin seleccionado
                red=red_seleccionada,
            ...
            data = {
               **process_velocimetro_v11_tamizaje_gestante(resultados_velocimetro_v11_tamizaje_gestante),
               **process_avance_mensual_v11_tamizaje_gestante(resultados_grafico_mensual_v11_tamizaje_gestante),
               **process_variables_v11_tamizaje_gestante(resultados_variables_v11_tamizaje_gestante),
               **process_variables_detallado_v11_tamizaje_gestante(resultados_variables_detallado_v11_tamizaje_gestante),
               **process_grafico_por_redes_v11_tamizaje_gestante(resultados_grafico_por_redes_v11_tamizaje_gestante),
               **process_grafico_por_microredes_v11_tamizaje_gestante(resultados_grafico_por_microredes_v11_tamizaje_gestante),
               **process_grafico_por_establecimientos_v11_tamizaje_gestante(resultados_grafico_por_establecimientos_v11_tamizaje_gestante)
            }

            # Agregar datos del resumen a la respuesta
            if resumen_v11_tamizaje_gestante:
                data['r_numerador_resumen'] = resumen_v11_tamizaje_gestante['numerador']
                data['r_denominador_resumen'] = resumen_v11_tamizaje_gestante['denominador']
                data['r_avance_resumen'] = resumen_v11_tamizaje_gestante['avance']
                data['r_brecha'] = resumen_v11_tamizaje_gestante['brecha']
                data['r_clasificacion'] = resumen_v11_tamizaje_gestante['clasificacion']
                data['r_color'] = resumen_v11_tamizaje_gestante['color']
                data['r_icono'] = resumen_v11_tamizaje_gestante['icono']
    ...
    return render(request, 'v11_tamizaje_gestante/index_v11_tamizaje_gestante.html', context)
...
def get_establecimientos_v11_tamizaje_gestante_h(request, establecimiento_id):
    """
    ...
    return render(request, 'v11_tamizaje_gestante/establecimientos_h.html', context)


def p_microredes_establec_v11_tamizaje_gestante_h(request):
    """
    ...
    return render(request, 'v11_tamizaje_gestante/partials/p_microredes_establec_h.html', context)


def p_establecimientos_v11_tamizaje_gestante_h(request):
    """
    ...
    return render(request, 'v11_tamizaje_gestante/partials/p_establecimientos_h.html', context)


def p_distritos_v11_tamizaje_gestante_h(request):
    """
    ...
    return render(request, 'v11_tamizaje_gestante/partials/p_distritos.html', context)
...
def get_redes_v11_tamizaje_gestante(request, redes_id):
    """
    Renderiza el formulario de reportes por REDES.
    """
    context = _get_context_base_con_filtros(include_meses=True)
    return render(request, 'v11_tamizaje_gestante/components/salud/redes.html', context)


def get_microredes_v11_tamizaje_gestante(request, microredes_id):
    """
    ...
    return render(request, 'v11_tamizaje_gestante/components/salud/microredes.html', context)


def get_establecimientos_v11_tamizaje_gestante(request, establecimiento_id):
    ...
    return render(request, 'v11_tamizaje_gestante/components/salud/establecimientos.html', context)
...
def p_microredes_v11_tamizaje_gestante(request):
    """
    ...
    return render(request, 'v11_tamizaje_gestante/partials/p_microredes.html', context)


def p_microredes_establec_v11_tamizaje_gestante(request):
    """
    ...
    return render(request, 'v11_tamizaje_gestante/partials/p_microredes_establec.html', {
        'microredes': microredes,
        'red': red,
    })
...
# ============================================
def p_establecimientos_v11_tamizaje_gestante(request):
    """
    ...
    return render(request, 'v11_tamizaje_gestante/partials/p_establecimientos.html', {
...
def get_provincias_v11_tamizaje_gestante(request, provincia_id):
    provincias = (
    ...
    return render(request, 'v11_tamizaje_gestante/components/municipio/provincias.html', context)

## SEGUIMIENTO POR DISTRITOS
def get_distritos_v11_tamizaje_gestante(request, distrito_id):
    provincias = (
                MAESTRO_HIS_ESTABLECIMIENTO
                .objects.filter(Descripcion_Sector='GOBIERNO REGIONAL')
                .annotate(ubigueo_filtrado=Substr('Ubigueo_Establecimiento', 1, 4))
    ...
    return render(request, 'v11_tamizaje_gestante/components/municipio/distritos.html', context)


def p_distrito_v11_tamizaje_gestante(request):
...
# Anchos de columnas
COLUMN_WIDTHS = {
    'A': 1, 'B': 9, 'C': 9, 'D': 20, 'E': 10, 'F': 10, 'G': 8, 'H': 8,
    'I':10,
    'J':10,'K':10,'L':10,'M':20,'N':10,'O':25,'P':10,'Q':25
}
...
class RptTamizajeGestante(BaseExcelReportView):
    """Reporte de captación de gestantes."""
    
    filename = "rpt_v11_tamizaje_gestante.xlsx"
    ...
    def get_data(self, params):
        return obtener_seguimiento_v11_tamizaje_gestante(
...
class RptTamizajeGestanteMicroRed(BaseExcelReportView):
    """Reporte de población por microred."""
    
    filename = "rpt_v11_tamizaje_gestante_microred.xlsx"
    sheet_name = "Seguimiento"
...
class RptTamizajeGestanteEstablec(BaseExcelReportView):
    """Reporte de población por establecimiento."""
    
    filename = "rpt_v11_tamizaje_gestante_establecimiento.xlsx"
    sheet_name = "Seguimiento"
...
def _style_header_sections(ws, style_mgr):
    ...
    sections_config = {
        ...
        'J5': ('NUMERADOR', 'naranja_claro', 10, True),
        # Fila 6: B6:G6, H6:K6 son rangos combinados, L6 es celda individual
        'B6': ('N° de gestantes con APN en establecimientos de salud del primer nivel de atención de salud, que le aplicaron la ficha de detección de violencia contra la mujer, en el mes de medición', 'gray', 10, True),
        'J6': ('Gestantes del den', 'gray', 8, True),
        ...
        'B7': ('Gestantes con atención prenatal (APN), en el mes de medicion', 'plomo_claro', 7, True),
        'E7': ('Atención prenatal (APN)', 'plomo_claro', 7, False),
        'H7': ('Ficha de deteccion', 'plomo_claro', 7, False),
        'J7': ('Tamizaje Positivo de violencia', 'plomo_claro', 7, False),
        ...
        'E8': ('DX = Z3491 ó Z3591 ó Z3492 ó Z3592 ó Z3493 ó Z3593', 'azul_claro', 7, True),
        'H8': ('DX = 96150.01', 'azul_claro', 7, False),
        'J8': ('DX = R456 + TD = D', 'azul_claro', 7, False)
    ...
    _apply_row_borders(ws, [5, 6, 7, 8], 'B', 'J', border_negro)
...
def _add_titles(ws, style_mgr):
    ...
    titles = [
        ...
        ('B4', 'SEGUIMIENTO NOMINAL:VI-01.01: CONDICIÓN PREVIA: PORCENTAJE DE GESTANTES ATENDIDAS, QUE CUENTAN CON TAMIZAJE POSITIVO DE VIOLENCIA CONTRA LA MUJER', 12, True, '000000'),
    ]
...
def _write_data(ws, results, style_mgr):
    ...
    for row_idx, record in enumerate(results, start=10):
        for col_idx, value in enumerate(record.values(), start=2):
            ...
            if col_idx == 10:  # Columna INDICADOR
