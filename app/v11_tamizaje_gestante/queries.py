...
## velocimetro
def obtener_velocimetro_v11_tamizaje_gestante(
    anio: str,
    ...
    try:
        with connection.cursor() as cursor:
            ...
            cursor.callproc('fn_obtener_velocimetro_v11_tamizaje_gestante', [
                anio,
                mes_inicio,
                mes_fin,
                red,
...
def obtener_grafico_mensual_v11_tamizaje_gestante(
    anio: str,
    mes_inicio: Optional[str],
    mes_fin: Optional[str],
    red: Optional[str],
    ...
    try:
        with connection.cursor() as cursor:
            # Llamar a la función almacenada con los parámetros en orden
            cursor.callproc('fn_grafico_mensualizado_v11_tamizaje_gestante', [
                anio,
                mes_inicio,
                mes_fin,
                red,
...
## grafico variables
def obtener_variables_v11_tamizaje_gestante(
    anio: str,
    mes_inicio: Optional[str],
    mes_fin: Optional[str],
    red: Optional[str],
    ...
    try:
        with connection.cursor() as cursor:
            # Llamar a la función almacenada con los parámetros en orden
            cursor.callproc('fn_obtener_variables_v11_tamizaje_gestante', [
                anio,
                mes_inicio,
                mes_fin,
                red,
            ...
            if row and len(row) >= 3:
                return [{
                    ...
                    'num_variable': int(row[1]) if row[1] is not None else 0,
                    'avance_num_variable': float(row[2]) if row[2] is not None else 0.0,
                }]
            else:
                # Sin datos en la tabla o número incorrecto de columnas
                if row:
                    logger.warning(f"La consulta de variables retornó {len(row)} columnas en lugar de 3")
                else:
...
def obtener_variables_detallado_v11_tamizaje_gestante(
    anio: str,
    mes_inicio: Optional[str],
    mes_fin: Optional[str],
    red: Optional[str],
    ...
    try:
        with connection.cursor() as cursor:
            # Llamar a la función almacenada con los parámetros en orden
            cursor.callproc('fn_obtener_variables_detallado_v11_tamizaje_gestante', [
                anio,
                mes_inicio,
                mes_fin,
                red,
                ...
                for row in rows:
                    if len(row) >= 13:
                        resultados.append({
                            ...
                            'd_avance_num_variable': float(row[12]) if row[12] is not None else 0.0,
                        })
                    else:
                        logger.warning(f"Una fila retornó {len(row)} columnas en lugar de 13, omitiendo...")
...
def obtener_grafico_por_redes_v11_tamizaje_gestante(
    anio: str,
    mes_inicio: Optional[str],
    mes_fin: Optional[str],
    red: Optional[str],
    ...
    try:
        with connection.cursor() as cursor:
            # Llamar a la función almacenada con los parámetros en orden
            cursor.callproc('fn_grafico_redes_v11_tamizaje_gestante', [
                anio,
                mes_inicio,
                mes_fin,
                red,
...
def obtener_grafico_por_microredes_v11_tamizaje_gestante(
    anio: str,
    mes_inicio: Optional[str],
    mes_fin: Optional[str],
    red: Optional[str],
    ...
    try:
        with connection.cursor() as cursor:
            # Llamar a la función almacenada con los parámetros en orden
            cursor.callproc('fn_grafico_microredes_v11_tamizaje_gestante', [
                anio,
                mes_inicio,
                mes_fin,
                red,
...
def obtener_grafico_por_establecimientos_v11_tamizaje_gestante(
    anio: str,
    mes_inicio: Optional[str],
    mes_fin: Optional[str],
    red: Optional[str],
    ...
    try:
        with connection.cursor() as cursor:
            # Llamar a la función almacenada con los parámetros en orden
            cursor.callproc('fn_grafico_establecimientos_v11_tamizaje_gestante', [
                anio,
                mes_inicio,
                mes_fin,
                red,
...
def obtener_seguimiento_v11_tamizaje_gestante(
    anio=None,
    mes_inicio=None,
    mes_fin=None,
    provincia='',
    ...
    try:
        with connection.cursor() as cursor:
            cursor.execute(
                """
                SELECT * FROM fn_seg_tamizaje_gestante(
                    %s, %s, %s, %s, %s, %s, %s, %s, %s
                )
                """,
                [
