...
## velocimetro
def obtener_velocimetro_s12_anemia_gestante(
    anio: str,
    ...
    try:
        with connection.cursor() as cursor:
            ...
            cursor.callproc('fn_obtener_velocimetro_s12_anemia_gestante', [
                anio,
                mes_inicio,
                mes_fin,
                red,
...
def obtener_grafico_mensual_s12_anemia_gestante(
    anio: str,
    mes_inicio: Optional[str],
    mes_fin: Optional[str],
    red: Optional[str],
    ...
    try:
        with connection.cursor() as cursor:
            # Llamar a la función almacenada con los parámetros en orden
            cursor.callproc('fn_grafico_mensualizado_s12_anemia_gestante', [
                anio,
                mes_inicio,
                mes_fin,
                red,
...
## grafico variables
def obtener_variables_s12_anemia_gestante(
    anio: str,
    mes_inicio: Optional[str],
    mes_fin: Optional[str],
    red: Optional[str],
...
def obtener_variables_detallado_s12_anemia_gestante(
    anio: str,
    mes_inicio: Optional[str],
    mes_fin: Optional[str],
    red: Optional[str],
...
def obtener_grafico_por_redes_s12_anemia_gestante(
    anio: str,
    mes_inicio: Optional[str],
    mes_fin: Optional[str],
    red: Optional[str],
...
def obtener_grafico_por_microredes_s12_anemia_gestante(
    anio: str,
    mes_inicio: Optional[str],
    mes_fin: Optional[str],
    red: Optional[str],
...
def obtener_grafico_por_establecimientos_s12_anemia_gestante(
    anio: str,
    mes_inicio: Optional[str],
    mes_fin: Optional[str],
    red: Optional[str],
...
def obtener_seguimiento_s12_anemia_gestante(
    anio=None,
    mes_inicio=None,
    mes_fin=None,
    provincia='',
