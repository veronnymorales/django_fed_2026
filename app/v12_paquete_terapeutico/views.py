...
from .queries import obtener_velocimetro_v12_paquete_terapeutico, obtener_grafico_mensual_v12_paquete_terapeutico, obtener_variables_v12_paquete_terapeutico, obtener_variables_detallado_v12_paquete_terapeutico, obtener_grafico_por_redes_v12_paquete_terapeutico
from .queries import obtener_grafico_por_microredes_v12_paquete_terapeutico, obtener_grafico_por_establecimientos_v12_paquete_terapeutico
from .queries import obtener_seguimiento_v12_paquete_terapeutico
...
######################################
## VELOCIMETRO
def process_velocimetro_v12_paquete_terapeutico(resultados_velocimetro_v12_paquete_terapeutico: List[Dict]) -> Dict[str, List]:
    """
    ...
    """
    # Validar entrada
    if not resultados_velocimetro_v12_paquete_terapeutico or len(resultados_velocimetro_v12_paquete_terapeutico) == 0:
    ...
    row = resultados_velocimetro_v12_paquete_terapeutico[0]
...
def obtener_resumen_indicador_v12_paquete_terapeutico(anio, mes_inicio, mes_fin, red, microred, establecimiento, provincia=None, distrito=None):
    """
    Obtiene un resumen detallado del indicador 
    """
    datos_base = obtener_velocimetro_v12_paquete_terapeutico(anio, mes_inicio, mes_fin, red, microred, establecimiento, provincia, distrito)
...
def process_avance_mensual_v12_paquete_terapeutico(resultados_avance_mensual_v12_paquete_terapeutico: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_avance_mensual_v12_paquete_terapeutico):
        try:
...
## GRAFICO VARIABLES 
def process_variables_v12_paquete_terapeutico(resultados_variables_v12_paquete_terapeutico: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_variables_v12_paquete_terapeutico):
        try:
            # Verifica que el diccionario tenga las claves necesarias
            required_keys = {'den_variable','num_csm1','avance_num_csm1','num_csm2','avance_num_csm2','num_psico1','avance_num_psico1','num_psico2','avance_num_psico2','num_psico3','avance_num_psico3','num_psico4','avance_num_psico4','num_psico5','avance_num_psico5','num_psico6','avance_num_psico6'}
            ...
            num_csm1 = row['num_csm1']
            avance_num_csm1 = row['avance_num_csm1']
            num_csm2 = row['num_csm2']
            avance_num_csm2 = row['avance_num_csm2']
            num_psico1 = row['num_psico1']
            avance_num_psico1 = row['avance_num_psico1']
            num_psico2 = row['num_psico2']
            avance_num_psico2 = row['avance_num_psico2']
            num_psico3 = row['num_psico3']
            avance_num_psico3 = row['avance_num_psico3']
            num_psico4 = row['num_psico4']
            avance_num_psico4 = row['avance_num_psico4']
            num_psico5 = row['num_psico5']
            avance_num_psico5 = row['avance_num_psico5']
            num_psico6 = row['num_psico6']
            avance_num_psico6 = row['avance_num_psico6']
            
            # Agrega los valores a la lista
            data['den_variable'].append(den_variable)
            data['num_csm1'].append(num_csm1)
            data['avance_num_csm1'].append(avance_num_csm1)
            data['num_csm2'].append(num_csm2)
            data['avance_num_csm2'].append(avance_num_csm2)
            data['num_psico1'].append(num_psico1)
            data['avance_num_psico1'].append(avance_num_psico1)
            data['num_psico2'].append(num_psico2)
            data['avance_num_psico2'].append(avance_num_psico2)
            data['num_psico3'].append(num_psico3)
            data['avance_num_psico3'].append(avance_num_psico3)
            data['num_psico4'].append(num_psico4)
            data['avance_num_psico4'].append(avance_num_psico4)
            data['num_psico5'].append(num_psico5)
            data['avance_num_psico5'].append(avance_num_psico5)
            data['num_psico6'].append(num_psico6)
            data['avance_num_psico6'].append(avance_num_psico6)
...
def process_variables_detallado_v12_paquete_terapeutico(resultados_variables_detallado_v12_paquete_terapeutico: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_variables_detallado_v12_paquete_terapeutico):
        try:
            # Verifica que el diccionario tenga las claves necesarias
            ...
            'd_den_variable','d_num_variable','d_num_csm1','d_avance_num_csm1','d_num_csm2','d_avance_num_csm2','d_num_psico1','d_avance_num_psico1','d_num_psico2','d_avance_num_psico2','d_num_psico3','d_avance_num_psico3','d_num_psico4','d_avance_num_psico4','d_num_psico5','d_avance_num_psico5','d_num_psico6','d_avance_num_psico6'}
            ...
            d_num_csm1 = row['d_num_csm1']
            d_avance_num_csm1 = row['d_avance_num_csm1']
            d_num_csm2 = row['d_num_csm2']
            d_avance_num_csm2 = row['d_avance_num_csm2']
            d_num_psico1 = row['d_num_psico1']
            d_avance_num_psico1 = row['d_avance_num_psico1']
            d_num_psico2 = row['d_num_psico2']
            d_avance_num_psico2 = row['d_avance_num_psico2']
            d_num_psico3 = row['d_num_psico3']
            d_avance_num_psico3 = row['d_avance_num_psico3']
            d_num_psico4 = row['d_num_psico4']
            d_avance_num_psico4 = row['d_avance_num_psico4']
            d_num_psico5 = row['d_num_psico5']
            d_avance_num_psico5 = row['d_avance_num_psico5']
            d_num_psico6 = row['d_num_psico6']
            d_avance_num_psico6 = row['d_avance_num_psico6']
            ...
            data['d_num_csm1'].append(d_num_csm1)
            data['d_avance_num_csm1'].append(d_avance_num_csm1)
            data['d_num_csm2'].append(d_num_csm2)
            data['d_avance_num_csm2'].append(d_avance_num_csm2)
            data['d_num_psico1'].append(d_num_psico1)
            data['d_avance_num_psico1'].append(d_avance_num_psico1)
            data['d_num_psico2'].append(d_num_psico2)
            data['d_avance_num_psico2'].append(d_avance_num_psico2)
            data['d_num_psico3'].append(d_num_psico3)
            data['d_avance_num_psico3'].append(d_avance_num_psico3)
            data['d_num_psico4'].append(d_num_psico4)
            data['d_avance_num_psico4'].append(d_avance_num_psico4)
            data['d_num_psico5'].append(d_num_psico5)
            data['d_avance_num_psico5'].append(d_avance_num_psico5)
            data['d_num_psico6'].append(d_num_psico6)
            data['d_avance_num_psico6'].append(d_avance_num_psico6)
...
def process_grafico_por_redes_v12_paquete_terapeutico(resultados_grafico_por_redes_v12_paquete_terapeutico: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_grafico_por_redes_v12_paquete_terapeutico):
        try:
            # Verifica que el diccionario tenga las claves necesarias
...
def process_grafico_por_microredes_v12_paquete_terapeutico(resultados_grafico_por_microredes_v12_paquete_terapeutico: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_grafico_por_microredes_v12_paquete_terapeutico):
        try:
            # Verifica que el diccionario tenga las claves necesarias
...
def process_grafico_por_establecimientos_v12_paquete_terapeutico(resultados_grafico_por_establecimientos_v12_paquete_terapeutico: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_grafico_por_establecimientos_v12_paquete_terapeutico):
        try:
            # Verifica que el diccionario tenga las claves necesarias
...
def index_v12_paquete_terapeutico(request):
    """
    ...
    if request.headers.get('x-requested-with') == 'XMLHttpRequest':
        try:
            ...
            resultados_velocimetro_v12_paquete_terapeutico = obtener_velocimetro_v12_paquete_terapeutico(
                anio=anio,
            ...
            resumen_v12_paquete_terapeutico = obtener_resumen_indicador_v12_paquete_terapeutico(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,
                mes_fin=mes_seleccionado_fin,
                red=red_seleccionada,
            ...
            resultados_grafico_mensual_v12_paquete_terapeutico = obtener_grafico_mensual_v12_paquete_terapeutico(
                anio=anio,
            ...
            resultados_variables_v12_paquete_terapeutico = obtener_variables_v12_paquete_terapeutico(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,
            ...
            resultados_variables_detallado_v12_paquete_terapeutico = obtener_variables_detallado_v12_paquete_terapeutico(
                anio=anio,
            ...
            resultados_grafico_por_redes_v12_paquete_terapeutico = obtener_grafico_por_redes_v12_paquete_terapeutico(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,  # Usa el mes de inicio seleccionado
                mes_fin=mes_seleccionado_fin,        # Usa el mes de fin seleccionado
                red=red_seleccionada,
            ...
            resultados_grafico_por_microredes_v12_paquete_terapeutico = obtener_grafico_por_microredes_v12_paquete_terapeutico(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,  # Usa el mes de inicio seleccionado
                mes_fin=mes_seleccionado_fin,        # Usa el mes de fin seleccionado
                red=red_seleccionada,
            ...
            resultados_grafico_por_establecimientos_v12_paquete_terapeutico = obtener_grafico_por_establecimientos_v12_paquete_terapeutico(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,  # Usa el mes de inicio seleccionado
                mes_fin=mes_seleccionado_fin,        # Usa el mes de fin seleccionado
                red=red_seleccionada,
            ...
            data = {
               **process_velocimetro_v12_paquete_terapeutico(resultados_velocimetro_v12_paquete_terapeutico),
               **process_avance_mensual_v12_paquete_terapeutico(resultados_grafico_mensual_v12_paquete_terapeutico),
               **process_variables_v12_paquete_terapeutico(resultados_variables_v12_paquete_terapeutico),
               **process_variables_detallado_v12_paquete_terapeutico(resultados_variables_detallado_v12_paquete_terapeutico),
               **process_grafico_por_redes_v12_paquete_terapeutico(resultados_grafico_por_redes_v12_paquete_terapeutico),
               **process_grafico_por_microredes_v12_paquete_terapeutico(resultados_grafico_por_microredes_v12_paquete_terapeutico),
               **process_grafico_por_establecimientos_v12_paquete_terapeutico(resultados_grafico_por_establecimientos_v12_paquete_terapeutico)
            }

            # Agregar datos del resumen a la respuesta
            if resumen_v12_paquete_terapeutico:
                data['r_numerador_resumen'] = resumen_v12_paquete_terapeutico['numerador']
                data['r_denominador_resumen'] = resumen_v12_paquete_terapeutico['denominador']
                data['r_avance_resumen'] = resumen_v12_paquete_terapeutico['avance']
                data['r_brecha'] = resumen_v12_paquete_terapeutico['brecha']
                data['r_clasificacion'] = resumen_v12_paquete_terapeutico['clasificacion']
                data['r_color'] = resumen_v12_paquete_terapeutico['color']
                data['r_icono'] = resumen_v12_paquete_terapeutico['icono']
    ...
    return render(request, 'v12_paquete_terapeutico/index_v12_paquete_terapeutico.html', context)
...
def get_establecimientos_v12_paquete_terapeutico_h(request, establecimiento_id):
    """
    ...
    return render(request, 'v12_paquete_terapeutico/establecimientos_h.html', context)


def p_microredes_establec_v12_paquete_terapeutico_h(request):
    """
    ...
    return render(request, 'v12_paquete_terapeutico/partials/p_microredes_establec_h.html', context)


def p_establecimientos_v12_paquete_terapeutico_h(request):
    """
    ...
    return render(request, 'v12_paquete_terapeutico/partials/p_establecimientos_h.html', context)


def p_distritos_v12_paquete_terapeutico_h(request):
    """
    ...
    return render(request, 'v12_paquete_terapeutico/partials/p_distritos.html', context)
...
def get_redes_v12_paquete_terapeutico(request, redes_id):
    """
    Renderiza el formulario de reportes por REDES.
    """
    context = _get_context_base_con_filtros(include_meses=True)
    return render(request, 'v12_paquete_terapeutico/components/salud/redes.html', context)


def get_microredes_v12_paquete_terapeutico(request, microredes_id):
    """
    ...
    return render(request, 'v12_paquete_terapeutico/components/salud/microredes.html', context)


def get_establecimientos_v12_paquete_terapeutico(request, establecimiento_id):
    ...
    return render(request, 'v12_paquete_terapeutico/components/salud/establecimientos.html', context)
...
def p_microredes_v12_paquete_terapeutico(request):
    """
    ...
    return render(request, 'v12_paquete_terapeutico/partials/p_microredes.html', context)


def p_microredes_establec_v12_paquete_terapeutico(request):
    """
    ...
    return render(request, 'v12_paquete_terapeutico/partials/p_microredes_establec.html', {
        'microredes': microredes,
        'red': red,
    })
...
# ============================================
def p_establecimientos_v12_paquete_terapeutico(request):
    """
    ...
    return render(request, 'v12_paquete_terapeutico/partials/p_establecimientos.html', {
...
def get_provincias_v12_paquete_terapeutico(request, provincia_id):
    provincias = (
    ...
    return render(request, 'v12_paquete_terapeutico/components/municipio/provincias.html', context)

## SEGUIMIENTO POR DISTRITOS
def get_distritos_v12_paquete_terapeutico(request, distrito_id):
    provincias = (
                MAESTRO_HIS_ESTABLECIMIENTO
                .objects.filter(Descripcion_Sector='GOBIERNO REGIONAL')
                .annotate(ubigueo_filtrado=Substr('Ubigueo_Establecimiento', 1, 4))
    ...
    return render(request, 'v12_paquete_terapeutico/components/municipio/distritos.html', context)


def p_distrito_v12_paquete_terapeutico(request):
...
# Anchos de columnas
COLUMN_WIDTHS = {
    'A': 1, 'B': 9, 'C': 20, 'D': 9, 'E': 8, 'F': 10, 'G': 8, 'H': 10,
    'I':5, 'J':5, 'K':5, 'L':5, 'M':5, 'N':5, 'O':8, 'P':10, 
    'Q':10, 'R':5, 'S':10, 'T':5, 'U':10, 'V':5, 'W':10, 'X':5, 'Y':10, 'Z':5,
    'AA':10, 'AB':5, 'AC':10, 'AD':5, 'AE':10, 'AF':5,  
    'AG':10,'AH':10,'AI':10,'AJ':20,'AK':10,'AL':25,'AM':10,'AN':25
}
...
HEADERS_CONFIG = [
    ...
    ('S9', '2° CSM','yellow'),
    ('T9', '2°','yellow'),
    ('U9', '1° PSICO','morado_claro'),
    ('V9', '1°','morado_claro'),
    ('W9', '2° PSICO','morado_claro'),
    ('X9', '2°','morado_claro'),
    ('Y9', '3° PSICO','morado_claro'),
    ('Z9', '3°','morado_claro'),
    ('AA9', '4° PSICO','morado_claro'),
    ('AB9', '4°','morado_claro'),
    ('AC9', '5° PSICO','morado_claro'),
    ('AD9', '5°','morado_claro'),
    ('AE9', '6° PSICO','morado_claro'),
    ('AF9', '6°','morado_claro'),   
    ('AG9', 'IND','blue'),
    ('AH9', 'MES','blue'),
    ('AI9', 'COD RED','orange'),
    ('AJ9', 'RED','orange'),
    ('AK9', 'COD MICRO','orange'),
    ('AL9', 'MICRORED','orange'),
    ('AM9', 'COD EESS','orange'),
    ('AN9', 'ESTABLECIMIENTO', 'orange')
]
...
MERGE_CELLS_CONFIG = [
    ...
    ('B7','C7'),('E7','F7'),('G7','H7'),('I7','N7'),('O7','P7'),('Q7','R7'),
    ('S7','T7'),('U7','V7'),('W7','X7'),('Y7','Z7'),('AA7','AB7'),('AC7','AD7'),('AE7','AF7'),
    # Fila 8: B8-C8 para descripción adolescentes, E8-F8 para descripción anemia
    ('B8','C8'),('E8','F8'),('G8','H8'),('Q8','R8'),
    ('S8','T8'),('U8','V8'),('W8','X8'),('Y8','Z8'),('AA8','AB8'),('AC8','AD8'),('AE8','AF8')
]
# ============================================================================
...
class RptPaqueteTerapeutico(BaseExcelReportView):
    """Reporte de captación de gestantes."""
    
    filename = "rpt_v12_paquete_terapeutico.xlsx"
    ...
    def get_data(self, params):
        return obtener_seguimiento_v12_paquete_terapeutico(
...
class RptPaqueteTerapeuticoMicroRed(BaseExcelReportView):
    """Reporte de población por microred."""
    
    filename = "rpt_v12_paquete_terapeutico_microred.xlsx"
    sheet_name = "Seguimiento"
...
class RptPaqueteTerapeuticoEstablec(BaseExcelReportView):
    """Reporte de población por establecimiento."""
    
    filename = "rpt_v12_paquete_terapeutico_establecimiento.xlsx"
    sheet_name = "Seguimiento"
...
def _style_header_sections(ws, style_mgr):
    ...
    sections_config = {
        ...
        'Q5': ('NUMERADOR (Paquete minimo de intervenciones terapeuticas especializadas)', 'naranja_claro', 10, True),
        # Fila 6: B6:G6, H6:K6 son rangos combinados, L6 es celda individual
        'B6': ('N° de gestantes atendidas en  establecimientos de salud del primer nivel de atención de salud con diagnostico de violencia', 'gray', 10, True),
        'Q6': ('Consulta Salud Mental', 'gray', 8, True),
        'U6': ('Psicoterapia', 'gray', 8, True),
        ...
        'D7': ('Parto en meses anteriores al mes de medición', 'plomo_claro', 7, False),
        'E7': ('Atención prenatal (APN) y Tamizaje de Violencia Positivo', 'plomo_claro', 7, False),
        'G7': ('Diagnóstico de Violencia, Hasta 15 días después del tamizaje positivo', 'plomo_claro', 7, False),
        'I7': ('Agrupación por "entregas" (1-6 meses desde diagnóstico) + Exclusión de gestantes que ya tuvieron parto', 'plomo_claro', 7, False),
        'O7': ('Entrega 1: 1 CSM + 1 Psicoterapia, Entrega 2: 2 CSM + 2 Psicoterapias, Entrega 3-6: 2 CSM + 3 - 6 Psicoterapias', 'plomo_claro', 7, False),
        'Q7': ('1° CSM,  hasta 30 días desde el diagnóstico de violencia', 'plomo_claro', 7, False),
        'S7': ('2° CSM con un intervalo mínimo 7 días y máximo de 30 días, a partir de la 1° CSM', 'plomo_claro', 7, False),
        'U7': ('1° psicoterapia  hasta 30 días desde el diagnóstico de violencia', 'plomo_claro', 7, False),
        'W7': ('Intervalo de min de 7 días y máx de 30 días después de la anterior', 'plomo_claro', 7, False),
        'Y7': ('Intervalo de min de 7 días y máx de 30 días después de la anterior', 'plomo_claro', 7, False),
        'AA7': ('Intervalo de min de 7 días y máx de 30 días después de la anterior', 'plomo_claro', 7, False),
        'AC7': ('Intervalo de min de 7 días y máx de 30 días después de la anterior', 'plomo_claro', 7, False),
        'AE7': ('Intervalo de min de 7 días y máx de 30 días después de la anterior', 'plomo_claro', 7, False),
        ...
        'D8': ('CNV EN LINEA', 'azul_claro', 7, True),
        'E8': ('DX = Z3491 ó Z3591 ó Z3492 ó Z3592 ó Z3493 ó Z3593', 'azul_claro', 7, False),
        'G8': ('DX= T740 ó T741 ó T742 ó T743 ó T748 ó T749 ó Y04-Y08 + TD = D ó P', 'azul_claro', 7, False),
        'I8': ('30 dias (1 m)', 'azul_claro', 7, False),
        'J8': ('60 dias (2 m)', 'azul_claro', 7, False),
        'K8': ('90 dias (3 m)', 'azul_claro', 7, False),
        'L8': ('120 dias (4 m)', 'azul_claro', 7, False),
        'M8': ('150 dias (5 m)', 'azul_claro', 7, False),
        'N8': ('180 dias (6 m)', 'azul_claro', 7, False),
        'Q8': ('DX =  99207 ó 99214.06 ó 99215', 'azul_claro', 7, False),
        'S8': ('DX =  99207 ó 99214.06 ó 99215', 'azul_claro', 7, False),
        'U8': ('DX= 99207.01 ó 90806 ó 90834 ó 90860', 'azul_claro', 7, False),
        'W8': ('DX= 99207.01 ó 90806 ó 90834 ó 90860', 'azul_claro', 7, False),
        'Y8': ('DX= 99207.01 ó 90806 ó 90834 ó 90860', 'azul_claro', 7, False),
        'AA8': ('DX= 99207.01 ó 90806 ó 90834 ó 90860', 'azul_claro', 7, False),
        'AC8': ('DX= 99207.01 ó 90806 ó 90834 ó 90860', 'azul_claro', 7, False),
        'AE8': ('DX= 99207.01 ó 90806 ó 90834 ó 90860', 'azul_claro', 7, False),
    }
    ...
    _apply_row_borders(ws, [5, 6, 7, 8], 'B', 'AF', border_negro)
