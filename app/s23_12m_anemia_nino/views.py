...
from .queries import obtener_velocimetro_s23_12m_anemia_nino, obtener_grafico_mensual_s23_12m_anemia_nino, obtener_variables_s23_12m_anemia_nino, obtener_variables_detallado_s23_12m_anemia_nino, obtener_grafico_por_redes_s23_12m_anemia_nino
from .queries import obtener_grafico_por_microredes_s23_12m_anemia_nino, obtener_grafico_por_establecimientos_s23_12m_anemia_nino
from .queries import obtener_seguimiento_s23_12m_anemia_nino
...
######################################
## VELOCIMETRO
def process_velocimetro_s23_12m_anemia_nino(resultados_velocimetro_s23_12m_anemia_nino: List[Dict]) -> Dict[str, List]:
    """
    ...
    """
    # Validar entrada
    if not resultados_velocimetro_s23_12m_anemia_nino or len(resultados_velocimetro_s23_12m_anemia_nino) == 0:
    ...
    row = resultados_velocimetro_s23_12m_anemia_nino[0]
...
def obtener_resumen_indicador_s23_12m_anemia_nino(anio, mes_inicio, mes_fin, red, microred, establecimiento, provincia=None, distrito=None):
    """
    Obtiene un resumen detallado del indicador 
    """
    datos_base = obtener_velocimetro_s23_12m_anemia_nino(anio, mes_inicio, mes_fin, red, microred, establecimiento, provincia, distrito)
...
def process_avance_mensual_s23_12m_anemia_nino(resultados_avance_mensual_s23_12m_anemia_nino: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_avance_mensual_s23_12m_anemia_nino):
        try:
...
## GRAFICO VARIABLES 
def process_variables_s23_12m_anemia_nino(resultados_variables_s23_12m_anemia_nino: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_variables_s23_12m_anemia_nino):
        try:
            # Verifica que el diccionario tenga las claves necesarias
            required_keys = {'den_variable','num_hierro_trat1','avance_hierro_trat1','num_hierro_trat2','avance_hierro_trat2',
            'num_hierro_trat3','avance_hierro_trat3','num_hb7m','avance_hb7m','num_hb8m','avance_hb8m','num_hb9m','avance_hb9m','num_hb12m','avance_hb12m'}
            ...
            num_hierro_trat1 = row['num_hierro_trat1']
            avance_hierro_trat1 = row['avance_hierro_trat1']
            num_hierro_trat2 = row['num_hierro_trat2']
            avance_hierro_trat2 = row['avance_hierro_trat2']
            num_hierro_trat3 = row['num_hierro_trat3']
            avance_hierro_trat3 = row['avance_hierro_trat3']
            num_hb7m = row['num_hb7m']
            avance_hb7m = row['avance_hb7m']
            num_hb8m = row['num_hb8m']
            avance_hb8m = row['avance_hb8m']
            ...
            data['num_hierro_trat1'].append(num_hierro_trat1)
            data['avance_hierro_trat1'].append(avance_hierro_trat1)
            data['num_hierro_trat2'].append(num_hierro_trat2)
            data['avance_hierro_trat2'].append(avance_hierro_trat2)
            data['num_hierro_trat3'].append(num_hierro_trat3)
            data['avance_hierro_trat3'].append(avance_hierro_trat3)
            data['num_hb7m'].append(num_hb7m)
            data['avance_hb7m'].append(avance_hb7m)
            data['num_hb8m'].append(num_hb8m)
            data['avance_hb8m'].append(avance_hb8m)
...
def process_variables_detallado_s23_12m_anemia_nino(resultados_variables_detallado_s23_12m_anemia_nino: List[Dict]) -> Dict[str, List]:
    ...
    data = {
        ...
        'd_num_variable': [],
        'd_num_hierro_trat1': [],
        'd_avance_hierro_trat1': [],
        'd_num_hierro_trat2': [],
        'd_avance_hierro_trat2': [],
        'd_num_hierro_trat3': [],
        'd_avance_hierro_trat3': [],
        'd_num_hb7m': [],
        'd_avance_hb7m': [],
        'd_num_hb8m': [],
        'd_avance_hb8m': [],
    ...
    for index, row in enumerate(resultados_variables_detallado_s23_12m_anemia_nino):
        try:
            # Verifica que el diccionario tenga las claves necesarias
            ...
            'd_num_hierro_trat1','d_avance_hierro_trat1','d_num_hierro_trat2','d_avance_hierro_trat2','d_num_hierro_trat3','d_avance_hierro_trat3','d_num_hb7m','d_avance_hb7m','d_num_hb8m','d_avance_hb8m','d_num_hb9m','d_avance_hb9m','d_num_hb12m','d_avance_hb12m'}
            ...
            d_num_hierro_trat1 = row['d_num_hierro_trat1']
            d_avance_hierro_trat1 = row['d_avance_hierro_trat1']
            d_num_hierro_trat2 = row['d_num_hierro_trat2']
            d_avance_hierro_trat2 = row['d_avance_hierro_trat2']
            d_num_hierro_trat3 = row['d_num_hierro_trat3']
            d_avance_hierro_trat3 = row['d_avance_hierro_trat3']
            d_num_hb7m = row['d_num_hb7m']
            d_avance_hb7m = row['d_avance_hb7m']
            d_num_hb8m = row['d_num_hb8m']
            d_avance_hb8m = row['d_avance_hb8m']
            ...
            data['d_num_hierro_trat1'].append(d_num_hierro_trat1)
            data['d_avance_hierro_trat1'].append(d_avance_hierro_trat1)
            data['d_num_hierro_trat2'].append(d_num_hierro_trat2)
            data['d_avance_hierro_trat2'].append(d_avance_hierro_trat2)
            data['d_num_hierro_trat3'].append(d_num_hierro_trat3)
            data['d_avance_hierro_trat3'].append(d_avance_hierro_trat3)
            data['d_num_hb7m'].append(d_num_hb7m)
            data['d_avance_hb7m'].append(d_avance_hb7m)
            data['d_num_hb8m'].append(d_num_hb8m)
            data['d_avance_hb8m'].append(d_avance_hb8m)
...
def process_grafico_por_redes_s23_12m_anemia_nino(resultados_grafico_por_redes_s23_12m_anemia_nino: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_grafico_por_redes_s23_12m_anemia_nino):
        try:
            # Verifica que el diccionario tenga las claves necesarias
...
def process_grafico_por_microredes_s23_12m_anemia_nino(resultados_grafico_por_microredes_s23_12m_anemia_nino: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_grafico_por_microredes_s23_12m_anemia_nino):
        try:
            # Verifica que el diccionario tenga las claves necesarias
...
def process_grafico_por_establecimientos_s23_12m_anemia_nino(resultados_grafico_por_establecimientos_s23_12m_anemia_nino: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_grafico_por_establecimientos_s23_12m_anemia_nino):
        try:
            # Verifica que el diccionario tenga las claves necesarias
...
def index_s23_12m_anemia_nino(request):
    """
    ...
    if request.headers.get('x-requested-with') == 'XMLHttpRequest':
        try:
            ...
            resultados_velocimetro_s23_12m_anemia_nino = obtener_velocimetro_s23_12m_anemia_nino(
                anio=anio,
            ...
            resumen_s23_12m_anemia_nino = obtener_resumen_indicador_s23_12m_anemia_nino(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,
                mes_fin=mes_seleccionado_fin,
                red=red_seleccionada,
            ...
            resultados_grafico_mensual_s23_12m_anemia_nino = obtener_grafico_mensual_s23_12m_anemia_nino(
                anio=anio,
            ...
            resultados_variables_s23_12m_anemia_nino = obtener_variables_s23_12m_anemia_nino(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,
            ...
            resultados_variables_detallado_s23_12m_anemia_nino = obtener_variables_detallado_s23_12m_anemia_nino(
                anio=anio,
            ...
            resultados_grafico_por_redes_s23_12m_anemia_nino = obtener_grafico_por_redes_s23_12m_anemia_nino(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,  # Usa el mes de inicio seleccionado
                mes_fin=mes_seleccionado_fin,        # Usa el mes de fin seleccionado
                red=red_seleccionada,
            ...
            resultados_grafico_por_microredes_s23_12m_anemia_nino = obtener_grafico_por_microredes_s23_12m_anemia_nino(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,  # Usa el mes de inicio seleccionado
                mes_fin=mes_seleccionado_fin,        # Usa el mes de fin seleccionado
                red=red_seleccionada,
            ...
            resultados_grafico_por_establecimientos_s23_12m_anemia_nino = obtener_grafico_por_establecimientos_s23_12m_anemia_nino(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,  # Usa el mes de inicio seleccionado
                mes_fin=mes_seleccionado_fin,        # Usa el mes de fin seleccionado
                red=red_seleccionada,
            ...
            data = {
               **process_velocimetro_s23_12m_anemia_nino(resultados_velocimetro_s23_12m_anemia_nino),
               **process_avance_mensual_s23_12m_anemia_nino(resultados_grafico_mensual_s23_12m_anemia_nino),
               **process_variables_s23_12m_anemia_nino(resultados_variables_s23_12m_anemia_nino),
               **process_variables_detallado_s23_12m_anemia_nino(resultados_variables_detallado_s23_12m_anemia_nino),
               **process_grafico_por_redes_s23_12m_anemia_nino(resultados_grafico_por_redes_s23_12m_anemia_nino),
               **process_grafico_por_microredes_s23_12m_anemia_nino(resultados_grafico_por_microredes_s23_12m_anemia_nino),
               **process_grafico_por_establecimientos_s23_12m_anemia_nino(resultados_grafico_por_establecimientos_s23_12m_anemia_nino)
            }

            # Agregar datos del resumen a la respuesta
            if resumen_s23_12m_anemia_nino:
                data['r_numerador_resumen'] = resumen_s23_12m_anemia_nino['numerador']
                data['r_denominador_resumen'] = resumen_s23_12m_anemia_nino['denominador']
                data['r_avance_resumen'] = resumen_s23_12m_anemia_nino['avance']
                data['r_brecha'] = resumen_s23_12m_anemia_nino['brecha']
                data['r_clasificacion'] = resumen_s23_12m_anemia_nino['clasificacion']
                data['r_color'] = resumen_s23_12m_anemia_nino['color']
                data['r_icono'] = resumen_s23_12m_anemia_nino['icono']
    ...
    return render(request, 's23_12m_anemia_nino/index_s23_12m_anemia_nino.html', context)
...
def get_establecimientos_s23_12m_anemia_nino_h(request, establecimiento_id):
    """
    ...
    return render(request, 's23_12m_anemia_nino/establecimientos_h.html', context)


def p_microredes_establec_s23_12m_anemia_nino_h(request):
    """
    ...
    return render(request, 's23_12m_anemia_nino/partials/p_microredes_establec_h.html', context)


def p_establecimientos_s23_12m_anemia_nino_h(request):
    """
    ...
    return render(request, 's23_12m_anemia_nino/partials/p_establecimientos_h.html', context)


def p_distritos_s23_12m_anemia_nino_h(request):
    """
    ...
    return render(request, 's23_12m_anemia_nino/partials/p_distritos.html', context)
...
def get_redes_s23_12m_anemia_nino(request, redes_id):
    """
    Renderiza el formulario de reportes por REDES.
    """
    context = _get_context_base_con_filtros(include_meses=True)
    return render(request, 's23_12m_anemia_nino/components/salud/redes.html', context)


def get_microredes_s23_12m_anemia_nino(request, microredes_id):
    """
    ...
    return render(request, 's23_12m_anemia_nino/components/salud/microredes.html', context)


def get_establecimientos_s23_12m_anemia_nino(request, establecimiento_id):
    ...
    return render(request, 's23_12m_anemia_nino/components/salud/establecimientos.html', context)
...
def p_microredes_s23_12m_anemia_nino(request):
    """
    ...
    return render(request, 's23_12m_anemia_nino/partials/p_microredes.html', context)


def p_microredes_establec_s23_12m_anemia_nino(request):
    """
    ...
    return render(request, 's23_12m_anemia_nino/partials/p_microredes_establec.html', {
        'microredes': microredes,
        'red': red,
    })
...
# ============================================
def p_establecimientos_s23_12m_anemia_nino(request):
    """
    ...
    return render(request, 's23_12m_anemia_nino/partials/p_establecimientos.html', {
...
def get_provincias_s23_12m_anemia_nino(request, provincia_id):
    provincias = (
    ...
    return render(request, 's23_12m_anemia_nino/components/municipio/provincias.html', context)

## SEGUIMIENTO POR DISTRITOS
def get_distritos_s23_12m_anemia_nino(request, distrito_id):
    provincias = (
                MAESTRO_HIS_ESTABLECIMIENTO
                .objects.filter(Descripcion_Sector='GOBIERNO REGIONAL')
                .annotate(ubigueo_filtrado=Substr('Ubigueo_Establecimiento', 1, 4))
    ...
    return render(request, 's23_12m_anemia_nino/components/municipio/distritos.html', context)


def p_distrito_s23_12m_anemia_nino(request):
...
class Rpt12mAnemiaNino(BaseExcelReportView):
    """Reporte de captación de gestantes."""
    
    filename = "rpt_s23_12m_anemia_nino.xlsx"
    ...
    def get_data(self, params):
        return obtener_seguimiento_s23_12m_anemia_nino(
...
class Rpt12mAnemiaNinoMicroRed(BaseExcelReportView):
    """Reporte de población por microred."""
    
    filename = "rpt_s23_12m_anemia_nino_microred.xlsx"
    sheet_name = "Seguimiento"
...
class Rpt12mAnemiaNinoEstablec(BaseExcelReportView):
    """Reporte de población por establecimiento."""
    
    filename = "rpt_s23_12m_anemia_nino_establecimiento.xlsx"
    sheet_name = "Seguimiento"
