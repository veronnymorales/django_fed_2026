...
def _add_titles(ws, style_mgr):
    ...
    titles = [
        ...
        ('B4', 'SEGUIMIENTO NOMINAL:SI-01.03: PORCENTAJE DE MUJERES CON PARTO INSTITUCIONAL SIN ANEMIA ATENDIDAS, QUE DURANTE SU GESTACIÓN RECIBIERON SUPLEMENTACIÓN PREVENTIVA CON HIERRO Y DOSAJES DE HEMOGLOBINA.', 12, True, '000000'),
    ]
