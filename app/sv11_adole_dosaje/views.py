...
from .queries import obtener_velocimetro_sv11_adole_dosaje, obtener_grafico_mensual_sv11_adole_dosaje, obtener_variables_sv11_adole_dosaje, obtener_variables_detallado_sv11_adole_dosaje, obtener_grafico_por_redes_sv11_adole_dosaje
from .queries import obtener_grafico_por_microredes_sv11_adole_dosaje, obtener_grafico_por_establecimientos_sv11_adole_dosaje
from .queries import obtener_seguimiento_sv11_adole_dosaje
...
######################################
## VELOCIMETRO
def process_velocimetro_sv11_adole_dosaje(resultados_velocimetro_sv11_adole_dosaje: List[Dict]) -> Dict[str, List]:
    """
    ...
    """
    # Validar entrada
    if not resultados_velocimetro_sv11_adole_dosaje or len(resultados_velocimetro_sv11_adole_dosaje) == 0:
    ...
    row = resultados_velocimetro_sv11_adole_dosaje[0]
...
def obtener_resumen_indicador_sv11_adole_dosaje(anio, mes_inicio, mes_fin, red, microred, establecimiento, provincia=None, distrito=None):
    """
    Obtiene un resumen detallado del indicador 
    """
    datos_base = obtener_velocimetro_sv11_adole_dosaje(anio, mes_inicio, mes_fin, red, microred, establecimiento, provincia, distrito)
...
def process_avance_mensual_sv11_adole_dosaje(resultados_avance_mensual_sv11_adole_dosaje: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_avance_mensual_sv11_adole_dosaje):
        try:
...
## GRAFICO VARIABLES 
def process_variables_sv11_adole_dosaje(resultados_variables_sv11_adole_dosaje: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_variables_sv11_adole_dosaje):
        try:
            # Verifica que el diccionario tenga las claves necesarias
...
def process_variables_detallado_sv11_adole_dosaje(resultados_variables_detallado_sv11_adole_dosaje: List[Dict]) -> Dict[str, List]:
    ...
    data = {
        ...
        'd_den_variable': [],
        'd_num_variable': [],
        'd_avance_num_variable': []
    }
    for index, row in enumerate(resultados_variables_detallado_sv11_adole_dosaje):
        try:
            # Verifica que el diccionario tenga las claves necesarias
            required_keys = {'d_anio','d_mes','d_codigo_red','d_red','d_codigo_microred','d_microred','d_codigo_unico','d_id_establecimiento','d_nombre_establecimiento','d_ubigueo_establecimiento','d_den_variable','d_num_variable','d_avance_num_variable'}
...
def process_grafico_por_redes_sv11_adole_dosaje(resultados_grafico_por_redes_sv11_adole_dosaje: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_grafico_por_redes_sv11_adole_dosaje):
        try:
            # Verifica que el diccionario tenga las claves necesarias
...
def process_grafico_por_microredes_sv11_adole_dosaje(resultados_grafico_por_microredes_sv11_adole_dosaje: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_grafico_por_microredes_sv11_adole_dosaje):
        try:
            # Verifica que el diccionario tenga las claves necesarias
...
def process_grafico_por_establecimientos_sv11_adole_dosaje(resultados_grafico_por_establecimientos_sv11_adole_dosaje: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_grafico_por_establecimientos_sv11_adole_dosaje):
        try:
            # Verifica que el diccionario tenga las claves necesarias
...
def index_sv11_adole_dosaje(request):
    """
    ...
    if request.headers.get('x-requested-with') == 'XMLHttpRequest':
        try:
            ...
            resultados_velocimetro_sv11_adole_dosaje = obtener_velocimetro_sv11_adole_dosaje(
                anio=anio,
            ...
            resumen_sv11_adole_dosaje = obtener_resumen_indicador_sv11_adole_dosaje(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,
                mes_fin=mes_seleccionado_fin,
                red=red_seleccionada,
            ...
            resultados_grafico_mensual_sv11_adole_dosaje = obtener_grafico_mensual_sv11_adole_dosaje(
                anio=anio,
            ...
            resultados_variables_sv11_adole_dosaje = obtener_variables_sv11_adole_dosaje(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,
            ...
            resultados_variables_detallado_sv11_adole_dosaje = obtener_variables_detallado_sv11_adole_dosaje(
                anio=anio,
            ...
            resultados_grafico_por_redes_sv11_adole_dosaje = obtener_grafico_por_redes_sv11_adole_dosaje(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,  # Usa el mes de inicio seleccionado
                mes_fin=mes_seleccionado_fin,        # Usa el mes de fin seleccionado
                red=red_seleccionada,
            ...
            resultados_grafico_por_microredes_sv11_adole_dosaje = obtener_grafico_por_microredes_sv11_adole_dosaje(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,  # Usa el mes de inicio seleccionado
                mes_fin=mes_seleccionado_fin,        # Usa el mes de fin seleccionado
                red=red_seleccionada,
            ...
            resultados_grafico_por_establecimientos_sv11_adole_dosaje = obtener_grafico_por_establecimientos_sv11_adole_dosaje(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,  # Usa el mes de inicio seleccionado
                mes_fin=mes_seleccionado_fin,        # Usa el mes de fin seleccionado
                red=red_seleccionada,
            ...
            data = {
               **process_velocimetro_sv11_adole_dosaje(resultados_velocimetro_sv11_adole_dosaje),
               **process_avance_mensual_sv11_adole_dosaje(resultados_grafico_mensual_sv11_adole_dosaje),
               **process_variables_sv11_adole_dosaje(resultados_variables_sv11_adole_dosaje),
               **process_variables_detallado_sv11_adole_dosaje(resultados_variables_detallado_sv11_adole_dosaje),
               **process_grafico_por_redes_sv11_adole_dosaje(resultados_grafico_por_redes_sv11_adole_dosaje),
               **process_grafico_por_microredes_sv11_adole_dosaje(resultados_grafico_por_microredes_sv11_adole_dosaje),
               **process_grafico_por_establecimientos_sv11_adole_dosaje(resultados_grafico_por_establecimientos_sv11_adole_dosaje)
            }

            # Agregar datos del resumen a la respuesta
            if resumen_sv11_adole_dosaje:
                data['r_numerador_resumen'] = resumen_sv11_adole_dosaje['numerador']
                data['r_denominador_resumen'] = resumen_sv11_adole_dosaje['denominador']
                data['r_avance_resumen'] = resumen_sv11_adole_dosaje['avance']
                data['r_brecha'] = resumen_sv11_adole_dosaje['brecha']
                data['r_clasificacion'] = resumen_sv11_adole_dosaje['clasificacion']
                data['r_color'] = resumen_sv11_adole_dosaje['color']
                data['r_icono'] = resumen_sv11_adole_dosaje['icono']
    ...
    return render(request, 'sv11_adole_dosaje/index_sv11_adole_dosaje.html', context)
...
def get_establecimientos_sv11_adole_dosaje_h(request, establecimiento_id):
    """
    ...
    return render(request, 'sv11_adole_dosaje/establecimientos_h.html', context)


def p_microredes_establec_sv11_adole_dosaje_h(request):
    """
    ...
    return render(request, 'sv11_adole_dosaje/partials/p_microredes_establec_h.html', context)


def p_establecimientos_sv11_adole_dosaje_h(request):
    """
    ...
    return render(request, 'sv11_adole_dosaje/partials/p_establecimientos_h.html', context)


def p_distritos_sv11_adole_dosaje_h(request):
    """
    ...
    return render(request, 'sv11_adole_dosaje/partials/p_distritos.html', context)
...
def get_redes_sv11_adole_dosaje(request, redes_id):
    """
    Renderiza el formulario de reportes por REDES.
    """
    context = _get_context_base_con_filtros(include_meses=True)
    return render(request, 'sv11_adole_dosaje/components/salud/redes.html', context)


def get_microredes_sv11_adole_dosaje(request, microredes_id):
    """
    ...
    return render(request, 'sv11_adole_dosaje/components/salud/microredes.html', context)


def get_establecimientos_sv11_adole_dosaje(request, establecimiento_id):
    ...
    return render(request, 'sv11_adole_dosaje/components/salud/establecimientos.html', context)
...
def p_microredes_sv11_adole_dosaje(request):
    """
    ...
    return render(request, 'sv11_adole_dosaje/partials/p_microredes.html', context)


def p_microredes_establec_sv11_adole_dosaje(request):
    """
    ...
    return render(request, 'sv11_adole_dosaje/partials/p_microredes_establec.html', {
        'microredes': microredes,
        'red': red,
    })
...
# ============================================
def p_establecimientos_sv11_adole_dosaje(request):
    """
    ...
    return render(request, 'sv11_adole_dosaje/partials/p_establecimientos.html', {
...
def get_provincias_sv11_adole_dosaje(request, provincia_id):
    provincias = (
    ...
    return render(request, 'sv11_adole_dosaje/components/municipio/provincias.html', context)

## SEGUIMIENTO POR DISTRITOS
def get_distritos_sv11_adole_dosaje(request, distrito_id):
    provincias = (
                MAESTRO_HIS_ESTABLECIMIENTO
                .objects.filter(Descripcion_Sector='GOBIERNO REGIONAL')
                .annotate(ubigueo_filtrado=Substr('Ubigueo_Establecimiento', 1, 4))
    ...
    return render(request, 'sv11_adole_dosaje/components/municipio/distritos.html', context)


def p_distrito_sv11_adole_dosaje(request):
...
class RptAdoleDosaje(BaseExcelReportView):
    """Reporte de captación de gestantes."""
    
    filename = "rpt_sv11_adole_dosaje.xlsx"
    ...
    def get_data(self, params):
        return obtener_seguimiento_sv11_adole_dosaje(
...
class RptAdoleDosajeMicroRed(BaseExcelReportView):
    """Reporte de población por microred."""
    
    filename = "rpt_sv11_adole_dosaje_microred.xlsx"
    sheet_name = "Seguimiento"
...
class RptAdoleDosajeEstablec(BaseExcelReportView):
    """Reporte de población por establecimiento."""
    
    filename = "rpt_sv11_adole_dosaje_establecimiento.xlsx"
    sheet_name = "Seguimiento"
