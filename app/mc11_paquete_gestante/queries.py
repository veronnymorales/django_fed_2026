...
DEFAULT_VARIABLES_DATA = {
    'den_variable': 0,
    'num_examenes1trim': 0,
    'avance_examenes1trim': 0.0,
    'num_apn': 0,
    'avance_num_apn': 0.0,
    'num_sulfato': 0,
    'avance_num_sulfato': 0.0,
    'num_dosaje_hb': 0,				
    'avance_num_dosaje_hb': 0.0,
    'num_tamizaje_sifilis': 0,				
    'avance_num_tamizaje_sifilis': 0.0,
    'num_tamizaje_VIH': 0,			
    'avance_num_tamizaje_VIH': 0.0,
    'num_tamizaje_bacteriuria': 0,	
    'avance_num_tamizaje_bacteriuria': 0.0,
    'num_perfil_obstetrico': 0,
    'avance_num_perfil_obstetrico': 0.0,
    'num_1trim_1apn': 0,
    'avance_num_1trim_1apn': 0.0,
    'num_2trim_1apn': 0,
    'avance_num_2trim_1apn': 0.0,
    'num_2trim_2apn': 0,
    'avance_num_2trim_2apn': 0.0,
    'num_3trim_1apn': 0,
    'avance_num_3trim_1apn': 0.0,
    'num_3trim_2apn': 0,
    'avance_num_3trim_2apn': 0.0,
    'num_3trim_3apn': 0,
    'avance_num_3trim_3apn': 0.0,
    'num_sulfato1': 0,
    'avance_num_sulfato1': 0.0,
    'num_sulfato2': 0,
    'avance_num_sulfato2': 0.0,
    'num_sulfato3': 0,
    'avance_num_sulfato3': 0.0,
    'num_sulfato4': 0,
    'avance_num_sulfato4': 0.0,
    'num_sulfato5': 0,
    'avance_num_sulfato5': 0.0
}
...
DEFAULT_VARIABLES_DETALLADO_DATA = {
    ...
    'd_den_variable': 0,
    'd_num_variable':0,
    'd_num_examenes1trim': 0,
    'd_avance_num_examenes1trim': 0.0,
    'd_num_apn': 0,
    'd_avance_num_apn': 0.0,
    'd_num_sulfato': 0,
    'd_avance_num_sulfato': 0.0,
    'd_num_dosaje_hb': 0,				
    'd_avance_num_dosaje_hb': 0.0,
    'd_num_tamizaje_sifilis': 0,				
    'd_avance_num_tamizaje_sifilis': 0.0,
    'd_num_tamizaje_VIH': 0,					
    'd_avance_num_tamizaje_VIH': 0.0,
    'd_num_tamizaje_bacteriuria': 0,		
    'd_avance_num_tamizaje_bacteriuria': 0.0,
    'd_num_perfil_obstetrico': 0,
    'd_avance_num_perfil_obstetrico': 0.0,
    'd_num_1trim_1apn': 0,
    'd_avance_num_1trim_1apn': 0.0,
    'd_num_2trim_1apn': 0,
    'd_avance_num_2trim_1apn': 0.0,
    'd_num_2trim_2apn': 0,
    'd_avance_num_2trim_2apn': 0.0,
    'd_num_3trim_1apn': 0,
    'd_avance_num_3trim_1apn': 0.0,
    'd_num_3trim_2apn': 0,
    'd_avance_num_3trim_2apn': 0.0,
    'd_num_3trim_3apn': 0,
    'd_avance_num_3trim_3apn': 0.0,
    'd_num_sulfato1': 0,
    'd_avance_num_sulfato1': 0.0,
    'd_num_sulfato2': 0,
    'd_avance_num_sulfato2': 0.0,
    'd_num_sulfato3': 0,
    'd_avance_num_sulfato3': 0.0,
    'd_num_sulfato4': 0,
    'd_avance_num_sulfato4': 0.0,
    'd_num_sulfato5': 0,
    'd_avance_num_sulfato5': 0.0
}
...
## velocimetro
def obtener_velocimetro_mc11_paquete_gestante(
    anio: str,
    ...
    try:
        with connection.cursor() as cursor:
            ...
            cursor.callproc('fn_obtener_velocimetro_mc11_paquete_gestante', [
                anio,
                mes_inicio,
                mes_fin,
                red,
...
def obtener_grafico_mensual_mc11_paquete_gestante(
    anio: str,
    mes_inicio: Optional[str],
    mes_fin: Optional[str],
    red: Optional[str],
    ...
    try:
        with connection.cursor() as cursor:
            # Llamar a la función almacenada con los parámetros en orden
            cursor.callproc('fn_grafico_mensualizado_mc11_paquete_gestante', [
                anio,
                mes_inicio,
                mes_fin,
                red,
...
## grafico variables
def obtener_variables_mc11_paquete_gestante(
    anio: str,
    mes_inicio: Optional[str],
    mes_fin: Optional[str],
    red: Optional[str],
    ...
    try:
        with connection.cursor() as cursor:
            # Llamar a la función almacenada con los parámetros en orden
            cursor.callproc('fn_obtener_variables_mc11_paquete_gestante', [
                anio,
                mes_inicio,
                mes_fin,
                red,
            ...
            if row and len(row) >= 39:
                return [{
                    ...
                    'num_examenes1trim': int(row[1]) if row[1] is not None else 0,
                    'avance_num_examenes1trim': float(row[2]) if row[2] is not None else 0.0,
                    'num_apn': int(row[3]) if row[3] is not None else 0,
                    'avance_num_apn': float(row[4]) if row[4] is not None else 0.0,
                    'num_sulfato': int(row[5]) if row[5] is not None else 0,
                    'avance_num_sulfato': float(row[6]) if row[6] is not None else 0.0,
                    'num_dosaje_hb': int(row[7]) if row[7] is not None else 0,
                    'avance_num_dosaje_hb': float(row[8]) if row[8] is not None else 0.0,
                    'num_tamizaje_sifilis': int(row[9]) if row[9] is not None else 0,
                    'avance_num_tamizaje_sifilis': float(row[10]) if row[10] is not None else 0.0,
                    'num_tamizaje_VIH': int(row[11]) if row[11] is not None else 0,
                    'avance_num_tamizaje_VIH': float(row[12]) if row[12] is not None else 0.0,
                    'num_tamizaje_bacteriuria': int(row[13]) if row[13] is not None else 0,
                    'avance_num_tamizaje_bacteriuria': float(row[14]) if row[14] is not None else 0.0,
                    'num_perfil_obstetrico': int(row[15]) if row[15] is not None else 0,
                    'avance_num_perfil_obstetrico': float(row[16]) if row[16] is not None else 0.0,
                    'num_1trim_1apn': int(row[17]) if row[17] is not None else 0,
                    'avance_num_1trim_1apn': float(row[18]) if row[18] is not None else 0.0,
                    'num_2trim_1apn': int(row[19]) if row[19] is not None else 0,
                    'avance_num_2trim_1apn': float(row[20]) if row[20] is not None else 0.0,
                    'num_2trim_2apn': int(row[21]) if row[21] is not None else 0,
                    'avance_num_2trim_2apn': float(row[22]) if row[22] is not None else 0.0,
                    'num_3trim_1apn': int(row[23]) if row[23] is not None else 0,
                    'avance_num_3trim_1apn': float(row[24]) if row[24] is not None else 0.0,
                    'num_3trim_2apn': int(row[25]) if row[25] is not None else 0,
                    'avance_num_3trim_2apn': float(row[26]) if row[26] is not None else 0.0,
                    'num_3trim_3apn': int(row[27]) if row[27] is not None else 0,
                    'avance_num_3trim_3apn': float(row[28]) if row[28] is not None else 0.0,
                    'num_sulfato1': int(row[29]) if row[29] is not None else 0,
                    'avance_num_sulfato1': float(row[30]) if row[30] is not None else 0.0,
                    'num_sulfato2': int(row[31]) if row[31] is not None else 0,
                    'avance_num_sulfato2': float(row[32]) if row[32] is not None else 0.0,
                    'num_sulfato3': int(row[33]) if row[33] is not None else 0,
                    'avance_num_sulfato3': float(row[34]) if row[34] is not None else 0.0,
                    'num_sulfato4': int(row[35]) if row[35] is not None else 0,
                    'avance_num_sulfato4': float(row[36]) if row[36] is not None else 0.0,
                    'num_sulfato5': int(row[37]) if row[37] is not None else 0,
                    'avance_num_sulfato5': float(row[38]) if row[38] is not None else 0.0
                }]
            else:
                # Sin datos en la tabla o número incorrecto de columnas
                if row:
                    logger.warning(f"La consulta de variables retornó {len(row)} columnas en lugar de 39")
                else:
...
def obtener_variables_detallado_mc11_paquete_gestante(
    anio: str,
    mes_inicio: Optional[str],
    mes_fin: Optional[str],
    red: Optional[str],
    ...
    try:
        with connection.cursor() as cursor:
            # Llamar a la función almacenada con los parámetros en orden
            cursor.callproc('fn_obtener_variables_detallado_mc11_paquete_gestante', [
                anio,
                mes_inicio,
                mes_fin,
                red,
                ...
                for row in rows:
                    if len(row) >= 50:
                        resultados.append({
                            ...
                            'd_num_examenes1trim': int(row[12]) if row[12] is not None else 0,
                            'd_avance_num_examenes1trim': float(row[13]) if row[13] is not None else 0.0,
                            'd_num_apn': int(row[14]) if row[14] is not None else 0,
                            'd_avance_num_apn': float(row[15]) if row[15] is not None else 0.0,
                            'd_num_sulfato': int(row[16]) if row[16] is not None else 0,
                            'd_avance_num_sulfato': float(row[17]) if row[17] is not None else 0.0,
                            'd_num_dosaje_hb': int(row[18]) if row[18] is not None else 0,
                            'd_avance_num_dosaje_hb': float(row[19]) if row[19] is not None else 0.0,
                            'd_num_tamizaje_sifilis': int(row[20]) if row[20] is not None else 0,
                            'd_avance_num_tamizaje_sifilis': float(row[21]) if row[21] is not None else 0.0,
                            'd_num_tamizaje_VIH': int(row[22]) if row[22] is not None else 0,
                            'd_avance_num_tamizaje_VIH': float(row[23]) if row[23] is not None else 0.0,
                            'd_num_tamizaje_bacteriuria': int(row[24]) if row[24] is not None else 0,
                            'd_avance_num_tamizaje_bacteriuria': float(row[25]) if row[25] is not None else 0.0,
                            'd_num_perfil_obstetrico': int(row[26]) if row[26] is not None else 0,
                            'd_avance_num_perfil_obstetrico': float(row[27]) if row[27] is not None else 0.0,
                            'd_num_1trim_1apn': int(row[28]) if row[28] is not None else 0,
                            'd_avance_num_1trim_1apn': float(row[29]) if row[29] is not None else 0.0,
                            'd_num_2trim_1apn': int(row[30]) if row[30] is not None else 0,
                            'd_avance_num_2trim_1apn': float(row[31]) if row[31] is not None else 0.0,
                            'd_num_2trim_2apn': int(row[32]) if row[32] is not None else 0,
                            'd_avance_num_2trim_2apn': float(row[33]) if row[33] is not None else 0.0,
                            'd_num_3trim_1apn': int(row[34]) if row[34] is not None else 0,
                            'd_avance_num_3trim_1apn': float(row[35]) if row[35] is not None else 0.0,
                            'd_num_3trim_2apn': int(row[36]) if row[36] is not None else 0,
                            'd_avance_num_3trim_2apn': float(row[37]) if row[37] is not None else 0.0,
                            'd_num_3trim_3apn': int(row[38]) if row[38] is not None else 0,
                            'd_avance_num_3trim_3apn': float(row[39]) if row[39] is not None else 0.0,
                            'd_num_sulfato1': int(row[40]) if row[40] is not None else 0,
                            'd_avance_num_sulfato1': float(row[41]) if row[41] is not None else 0.0,
                            'd_num_sulfato2': int(row[42]) if row[42] is not None else 0,
                            'd_avance_num_sulfato2': float(row[43]) if row[43] is not None else 0.0,
                            'd_num_sulfato3': int(row[44]) if row[44] is not None else 0,
                            'd_avance_num_sulfato3': float(row[45]) if row[45] is not None else 0.0,
                            'd_num_sulfato4': int(row[46]) if row[46] is not None else 0,
                            'd_avance_num_sulfato4': float(row[47]) if row[47] is not None else 0.0,
                            'd_num_sulfato5': int(row[48]) if row[48] is not None else 0,
                            'd_avance_num_sulfato5': float(row[49]) if row[49] is not None else 0.0
                        })
                    else:
                        logger.warning(f"Una fila retornó {len(row)} columnas en lugar de 50, omitiendo...")
...
def obtener_grafico_por_redes_mc11_paquete_gestante(
    anio: str,
    mes_inicio: Optional[str],
    mes_fin: Optional[str],
    red: Optional[str],
    ...
    try:
        with connection.cursor() as cursor:
            # Llamar a la función almacenada con los parámetros en orden
            cursor.callproc('fn_grafico_redes_mc11_paquete_gestante', [
                anio,
                mes_inicio,
                mes_fin,
                red,
...
def obtener_grafico_por_microredes_mc11_paquete_gestante(
    anio: str,
    mes_inicio: Optional[str],
    mes_fin: Optional[str],
    red: Optional[str],
    ...
    try:
        with connection.cursor() as cursor:
            # Llamar a la función almacenada con los parámetros en orden
            cursor.callproc('fn_grafico_microredes_mc11_paquete_gestante', [
                anio,
                mes_inicio,
                mes_fin,
                red,
...
def obtener_grafico_por_establecimientos_mc11_paquete_gestante(
    anio: str,
    mes_inicio: Optional[str],
    mes_fin: Optional[str],
    red: Optional[str],
    ...
    try:
        with connection.cursor() as cursor:
            # Llamar a la función almacenada con los parámetros en orden
            cursor.callproc('fn_grafico_establecimientos_mc11_paquete_gestante', [
                anio,
                mes_inicio,
                mes_fin,
                red,
...
def obtener_seguimiento_mc11_paquete_gestante(
    anio=None,
    mes_inicio=None,
    mes_fin=None,
    provincia='',
    ...
    try:
        with connection.cursor() as cursor:
            cursor.execute(
                """
                SELECT * FROM fn_seg_paquete_gestante(
                    %s, %s, %s, %s, %s, %s, %s, %s, %s
                )
                """,
                [
