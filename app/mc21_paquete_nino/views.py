...
from .queries import obtener_velocimetro_mc21_paquete_nino, obtener_grafico_mensual_mc21_paquete_nino, obtener_variables_mc21_paquete_nino, obtener_variables_detallado_mc21_paquete_nino, obtener_grafico_por_redes_mc21_paquete_nino
from .queries import obtener_grafico_por_microredes_mc21_paquete_nino, obtener_grafico_por_establecimientos_mc21_paquete_nino
from .queries import obtener_seguimiento_mc21_paquete_nino
...
######################################
## VELOCIMETRO
def process_velocimetro_mc21_paquete_nino(resultados_velocimetro_mc21_paquete_nino: List[Dict]) -> Dict[str, List]:
    """
    ...
    """
    # Validar entrada
    if not resultados_velocimetro_mc21_paquete_nino or len(resultados_velocimetro_mc21_paquete_nino) == 0:
    ...
    row = resultados_velocimetro_mc21_paquete_nino[0]
...
def obtener_resumen_indicador_mc21_paquete_nino(anio, mes_inicio, mes_fin, red, microred, establecimiento, provincia=None, distrito=None):
    """
    Obtiene un resumen detallado del indicador 
    """
    datos_base = obtener_velocimetro_mc21_paquete_nino(anio, mes_inicio, mes_fin, red, microred, establecimiento, provincia, distrito)
...
def process_avance_mensual_mc21_paquete_nino(resultados_avance_mensual_mc21_paquete_nino: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_avance_mensual_mc21_paquete_nino):
        try:
...
## GRAFICO VARIABLES 
def process_variables_mc21_paquete_nino(resultados_variables_mc21_paquete_nino: List[Dict]) -> Dict[str, List]:
    ...
    data = {
            ...
            'avance_num_sindni': [],
            'num_vac_antineumo': [],
            'avance_num_vac_antineumo': [],
            'num_vac_polio': [],
            'avance_num_vac_polio': [],
            'num_vac_rota': [],
            'avance_num_vac_rota': [],
            'num_vac_penta': [],
            'avance_num_vac_penta': [],
            'num_esq4m': [],
            'avance_num_esq4m': [],
            'num_esq6m': [],
            'avance_num_esq6m': [],
    ...
    for index, row in enumerate(resultados_variables_mc21_paquete_nino):
        try:
            # Verifica que el diccionario tenga las claves necesarias
            required_keys = {'den_variable','num_sindni','avance_num_sindni','num_vac_antineumo','avance_num_vac_antineumo',
            'num_vac_polio','avance_num_vac_polio','num_vac_rota','avance_num_vac_rota','num_vac_penta','avance_num_vac_penta','num_esq4m','avance_num_esq4m','num_esq6m','avance_num_esq6m','num_dosaje_hb','avance_num_dosaje_hb','num_dniemision30d','avance_num_dniemision30d'}
            ...
            num_sindni = row['num_sindni']
            avance_num_sindni = row['avance_num_sindni']
            num_vac_antineumo = row['num_vac_antineumo']
            avance_num_vac_antineumo = row['avance_num_vac_antineumo']
            num_vac_polio = row['num_vac_polio']
            avance_num_vac_polio = row['avance_num_vac_polio']
            num_vac_rota = row['num_vac_rota']
            avance_num_vac_rota = row['avance_num_vac_rota']
            num_vac_penta = row['num_vac_penta']
            avance_num_vac_penta = row['avance_num_vac_penta']
            num_esq4m = row['num_esq4m']
            avance_num_esq4m = row['avance_num_esq4m']
            num_esq6m = row['num_esq6m']
            avance_num_esq6m = row['avance_num_esq6m']
            num_dosaje_hb = row['num_dosaje_hb']
            avance_num_dosaje_hb = row['avance_num_dosaje_hb']
            num_dniemision30d = row['num_dniemision30d']
            avance_num_dniemision30d = row['avance_num_dniemision30d']
            
            # Agrega los valores a la lista
            data['den_variable'].append(den_variable)
            data['num_sindni'].append(num_sindni)
            data['avance_num_sindni'].append(avance_num_sindni)
            data['num_vac_antineumo'].append(num_vac_antineumo)
            data['avance_num_vac_antineumo'].append(avance_num_vac_antineumo)
            data['num_vac_polio'].append(num_vac_polio)
            data['avance_num_vac_polio'].append(avance_num_vac_polio)
            data['num_vac_rota'].append(num_vac_rota)
            data['avance_num_vac_rota'].append(avance_num_vac_rota)
            data['num_vac_penta'].append(num_vac_penta)
            data['avance_num_vac_penta'].append(avance_num_vac_penta)
            data['num_esq4m'].append(num_esq4m)
            data['avance_num_esq4m'].append(avance_num_esq4m)
            data['num_esq6m'].append(num_esq6m)
            data['avance_num_esq6m'].append(avance_num_esq6m)
            data['num_dosaje_hb'].append(num_dosaje_hb)
            data['avance_num_dosaje_hb'].append(avance_num_dosaje_hb)
            data['num_dniemision30d'].append(num_dniemision30d)
            data['avance_num_dniemision30d'].append(avance_num_dniemision30d)
...
def process_variables_detallado_mc21_paquete_nino(resultados_variables_detallado_mc21_paquete_nino: List[Dict]) -> Dict[str, List]:
    ...
    data = {
        ...
        'd_avance_num_sindni': [],
        'd_num_vac_antineumo': [],
        'd_avance_num_vac_antineumo': [],
        'd_num_vac_polio': [],
        'd_avance_num_vac_polio': [],
        'd_num_vac_rota': [],
        'd_avance_num_vac_rota': [],
        'd_num_vac_penta': [],
        'd_avance_num_vac_penta': [],
        'd_num_esq4m': [],
        'd_avance_num_esq4m': [],
        'd_num_esq6m': [],
        'd_avance_num_esq6m': [],
        ...
        'd_num_dniemision30d': [],
        'd_avance_num_dniemision30d': []
    }

    for index, row in enumerate(resultados_variables_detallado_mc21_paquete_nino):
        try:
            # Verifica que el diccionario tenga las claves necesarias
            ...
            'd_den_variable','d_num_variable','d_num_sindni','d_avance_num_sindni','d_num_vac_antineumo','d_avance_num_vac_antineumo','d_num_vac_polio','d_avance_num_vac_polio','d_num_vac_rota',
            'd_avance_num_vac_rota','d_num_vac_penta','d_avance_num_vac_penta','d_num_esq4m','d_avance_num_esq4m','d_num_esq6m','d_avance_num_esq6m','d_num_dosaje_hb','d_avance_num_dosaje_hb','d_num_dniemision30d','d_avance_num_dniemision30d'}
            ...
            d_num_sindni = row['d_num_sindni']
            d_avance_num_sindni = row['d_avance_num_sindni']
            d_num_vac_antineumo = row['d_num_vac_antineumo']
            d_avance_num_vac_antineumo = row['d_avance_num_vac_antineumo']
            d_num_vac_polio = row['d_num_vac_polio']
            d_avance_num_vac_polio = row['d_avance_num_vac_polio']
            d_num_vac_rota = row['d_num_vac_rota']
            d_avance_num_vac_rota = row['d_avance_num_vac_rota']
            d_num_vac_penta = row['d_num_vac_penta']
            d_avance_num_vac_penta = row['d_avance_num_vac_penta']
            d_num_esq4m = row['d_num_esq4m']
            d_avance_num_esq4m = row['d_avance_num_esq4m']
            d_num_esq6m = row['d_num_esq6m']
            d_avance_num_esq6m = row['d_avance_num_esq6m']
            d_num_dosaje_hb = row['d_num_dosaje_hb']
            d_avance_num_dosaje_hb = row['d_avance_num_dosaje_hb']
            d_num_dniemision30d = row['d_num_dniemision30d']
            d_avance_num_dniemision30d = row['d_avance_num_dniemision30d']
            ...
            data['d_num_sindni'].append(d_num_sindni)
            data['d_avance_num_sindni'].append(d_avance_num_sindni)
            data['d_num_vac_antineumo'].append(d_num_vac_antineumo)
            data['d_avance_num_vac_antineumo'].append(d_avance_num_vac_antineumo)
            data['d_num_vac_polio'].append(d_num_vac_polio)
            data['d_avance_num_vac_polio'].append(d_avance_num_vac_polio)
            data['d_num_vac_rota'].append(d_num_vac_rota)
            data['d_avance_num_vac_rota'].append(d_avance_num_vac_rota)
            data['d_num_vac_penta'].append(d_num_vac_penta)
            data['d_avance_num_vac_penta'].append(d_avance_num_vac_penta)
            data['d_num_esq4m'].append(d_num_esq4m)
            data['d_avance_num_esq4m'].append(d_avance_num_esq4m)
            data['d_num_esq6m'].append(d_num_esq6m)
            data['d_avance_num_esq6m'].append(d_avance_num_esq6m)
            data['d_num_dosaje_hb'].append(d_num_dosaje_hb)
            data['d_avance_num_dosaje_hb'].append(d_avance_num_dosaje_hb)
            data['d_num_dniemision30d'].append(d_num_dniemision30d)
            data['d_avance_num_dniemision30d'].append(d_avance_num_dniemision30d)
...
def process_grafico_por_redes_mc21_paquete_nino(resultados_grafico_por_redes_mc21_paquete_nino: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_grafico_por_redes_mc21_paquete_nino):
        try:
            # Verifica que el diccionario tenga las claves necesarias
...
def process_grafico_por_microredes_mc21_paquete_nino(resultados_grafico_por_microredes_mc21_paquete_nino: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_grafico_por_microredes_mc21_paquete_nino):
        try:
            # Verifica que el diccionario tenga las claves necesarias
...
def process_grafico_por_establecimientos_mc21_paquete_nino(resultados_grafico_por_establecimientos_mc21_paquete_nino: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_grafico_por_establecimientos_mc21_paquete_nino):
        try:
            # Verifica que el diccionario tenga las claves necesarias
...
def index_mc21_paquete_nino(request):
    """
    ...
    if request.headers.get('x-requested-with') == 'XMLHttpRequest':
        try:
            ...
            resultados_velocimetro_mc21_paquete_nino = obtener_velocimetro_mc21_paquete_nino(
                anio=anio,
            ...
            resumen_mc21_paquete_nino = obtener_resumen_indicador_mc21_paquete_nino(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,
                mes_fin=mes_seleccionado_fin,
                red=red_seleccionada,
            ...
            resultados_grafico_mensual_mc21_paquete_nino = obtener_grafico_mensual_mc21_paquete_nino(
                anio=anio,
            ...
            resultados_variables_mc21_paquete_nino = obtener_variables_mc21_paquete_nino(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,
            ...
            resultados_variables_detallado_mc21_paquete_nino = obtener_variables_detallado_mc21_paquete_nino(
                anio=anio,
            ...
            resultados_grafico_por_redes_mc21_paquete_nino = obtener_grafico_por_redes_mc21_paquete_nino(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,  # Usa el mes de inicio seleccionado
                mes_fin=mes_seleccionado_fin,        # Usa el mes de fin seleccionado
                red=red_seleccionada,
            ...
            resultados_grafico_por_microredes_mc21_paquete_nino = obtener_grafico_por_microredes_mc21_paquete_nino(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,  # Usa el mes de inicio seleccionado
                mes_fin=mes_seleccionado_fin,        # Usa el mes de fin seleccionado
                red=red_seleccionada,
            ...
            resultados_grafico_por_establecimientos_mc21_paquete_nino = obtener_grafico_por_establecimientos_mc21_paquete_nino(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,  # Usa el mes de inicio seleccionado
                mes_fin=mes_seleccionado_fin,        # Usa el mes de fin seleccionado
                red=red_seleccionada,
            ...
            data = {
               **process_velocimetro_mc21_paquete_nino(resultados_velocimetro_mc21_paquete_nino),
               **process_avance_mensual_mc21_paquete_nino(resultados_grafico_mensual_mc21_paquete_nino),
               **process_variables_mc21_paquete_nino(resultados_variables_mc21_paquete_nino),
               **process_variables_detallado_mc21_paquete_nino(resultados_variables_detallado_mc21_paquete_nino),
               **process_grafico_por_redes_mc21_paquete_nino(resultados_grafico_por_redes_mc21_paquete_nino),
               **process_grafico_por_microredes_mc21_paquete_nino(resultados_grafico_por_microredes_mc21_paquete_nino),
               **process_grafico_por_establecimientos_mc21_paquete_nino(resultados_grafico_por_establecimientos_mc21_paquete_nino)
            }

            # Agregar datos del resumen a la respuesta
            if resumen_mc21_paquete_nino:
                data['r_numerador_resumen'] = resumen_mc21_paquete_nino['numerador']
                data['r_denominador_resumen'] = resumen_mc21_paquete_nino['denominador']
                data['r_avance_resumen'] = resumen_mc21_paquete_nino['avance']
                data['r_brecha'] = resumen_mc21_paquete_nino['brecha']
                data['r_clasificacion'] = resumen_mc21_paquete_nino['clasificacion']
                data['r_color'] = resumen_mc21_paquete_nino['color']
                data['r_icono'] = resumen_mc21_paquete_nino['icono']
    ...
    return render(request, 'mc21_paquete_nino/index_mc21_paquete_nino.html', context)
...
def get_establecimientos_mc21_paquete_nino_h(request, establecimiento_id):
    """
    ...
    return render(request, 'mc21_paquete_nino/establecimientos_h.html', context)


def p_microredes_establec_mc21_paquete_nino_h(request):
    """
    ...
    return render(request, 'mc21_paquete_nino/partials/p_microredes_establec_h.html', context)


def p_establecimientos_mc21_paquete_nino_h(request):
    """
    ...
    return render(request, 'mc21_paquete_nino/partials/p_establecimientos_h.html', context)


def p_distritos_mc21_paquete_nino_h(request):
    """
    ...
    return render(request, 'mc21_paquete_nino/partials/p_distritos.html', context)
...
def get_redes_mc21_paquete_nino(request, redes_id):
    """
    Renderiza el formulario de reportes por REDES.
    """
    context = _get_context_base_con_filtros(include_meses=True)
    return render(request, 'mc21_paquete_nino/components/salud/redes.html', context)


def get_microredes_mc21_paquete_nino(request, microredes_id):
    """
    ...
    return render(request, 'mc21_paquete_nino/components/salud/microredes.html', context)


def get_establecimientos_mc21_paquete_nino(request, establecimiento_id):
    ...
    return render(request, 'mc21_paquete_nino/components/salud/establecimientos.html', context)
...
def p_microredes_mc21_paquete_nino(request):
    """
    ...
    return render(request, 'mc21_paquete_nino/partials/p_microredes.html', context)


def p_microredes_establec_mc21_paquete_nino(request):
    """
    ...
    return render(request, 'mc21_paquete_nino/partials/p_microredes_establec.html', {
        'microredes': microredes,
        'red': red,
    })
...
# ============================================
def p_establecimientos_mc21_paquete_nino(request):
    """
    ...
    return render(request, 'mc21_paquete_nino/partials/p_establecimientos.html', {
...
def get_provincias_mc21_paquete_nino(request, provincia_id):
    provincias = (
    ...
    return render(request, 'mc21_paquete_nino/components/municipio/provincias.html', context)

## SEGUIMIENTO POR DISTRITOS
def get_distritos_mc21_paquete_nino(request, distrito_id):
    provincias = (
                MAESTRO_HIS_ESTABLECIMIENTO
                .objects.filter(Descripcion_Sector='GOBIERNO REGIONAL')
                .annotate(ubigueo_filtrado=Substr('Ubigueo_Establecimiento', 1, 4))
    ...
    return render(request, 'mc21_paquete_nino/components/municipio/distritos.html', context)


def p_distrito_mc21_paquete_nino(request):
...
# Anchos de columnas
COLUMN_WIDTHS = {
    'A': 1, 'B': 9, 'C': 9, 'D': 9, 'E': 25, 'F': 9, 'G': 10, 'H': 8,'I':10, 'J':9, 'K':9,
    'L':5, 'M':5, 'N':5, 'O':9,'P':5,'Q':9, 
    'R':9, 'S':9, 'T':9, 'U':9, 'V':9,'W':9, 'X':9, 'Y':9, 'Z':9,
    'AA':12,'AB':5,'AC':9,'AD':20,'AE':9,'AF':25,'AG':9,'AH':25
}
...
HEADERS_CONFIG = [
    ...
    ('AC9', 'COD RED','orange'),
    ('AD9', 'RED','orange'),
    ('AE9', 'COD MICRO','orange'),
    ('AF9', 'MICRORED','orange'),
    ('AG9', 'COD EESS','orange'),
    ('AH9', 'ESTABLECIMIENTO', 'orange')
]
...
class RptPaqueteNino(BaseExcelReportView):
    ...
    filename = "rpt_mc21_paquete_nino.xlsx"
    ...
    def get_data(self, params):
        return obtener_seguimiento_mc21_paquete_nino(
...
class RptPaqueteNinoMicroRed(BaseExcelReportView):
    ...
    filename = "rpt_mc21_paquete_nino_microred.xlsx"
    sheet_name = "Seguimiento"
...
class RptPaqueteNinoEstablec(BaseExcelReportView):
    ...
    filename = "rpt_mc21_paquete_nino_establecimiento.xlsx"
    sheet_name = "Seguimiento"
...
def _style_header_sections(ws, style_mgr):
    ...
    sections_config = {
        ...
        'R5': ('NUMERADOR (N° de niñas y niños del denominador que reciben el paquete integrado de servicios según edad, y que han sido registrados en HIS  y cuentan con DNI emitido)', 'naranja_claro', 10, True),
        # Fila 6: B6:Q6 descripción denominador, S6:V6 vacunas, W6:Y6 suplementación (R6, Z6 son individuales)
        'B6': ('N° de niñas y niños menores de 12 meses de edad en el mes de medición, procedentes de distritos de quintiles 1 y 2, registrados en el padrón nominal con DNI o CNV, con tipo de seguro SIS o sin Seguro', 'gray', 10, True),
        'R6': ('DNI', 'gray', 8, True),
        'S6': ('VACUNAS SEGÚN EDAD', 'gray', 8, True),
        'W6': ('ESQUEMA DE SUPLEMENTACION/TRATAMIENTO', 'gray', 8, True),
        'Z6': ('DNI 30D', 'gray', 8, True),
        ...
        'R7': ('Niños con 7 componentes (con DNI)', 'plomo_claro', 7, False),
        'S7': ('Vacunas antineumococica (2 dosis)', 'plomo_claro', 7, False),
        'T7': ('Vacunas antipolio (3 dosis)', 'plomo_claro', 7, False),
        'U7': ('Vacunas rotavirus (2 dosis)', 'plomo_claro', 7, False),
        'V7': ('Vacunas pentavalente (3 dosis)', 'plomo_claro', 7, False),
        'W7': ('Suplementación  de 4 a 5 meses', 'plomo_claro', 7, False),
        'X7': ('Suple/Trata de 6 a 11 meses', 'plomo_claro', 7, False),
        'Y7': ('Dosaje de Hemoglobina', 'plomo_claro', 7, False),
        'Z7': ('Emisión de DNI hasta los 30 dias', 'plomo_claro', 7, False),
        

        # Fila 8: B8:C8 intervalos, D8:L8 descripción, M8:Q8 excluir prematuros
        # Celdas S8-Y8 son individuales para códigos DX
        'B8': ('CODIGO HIS', 'azul_claro', 7, True),
        'M8': ('Excluir: Prematuros y BPN (desde CNV)', 'azul_claro', 7, False),
        'S8': ('DX = 90670 ó 90677', 'azul_claro', 7, False),
        'T8': ('DX=90712 ó 90713', 'azul_claro', 7, False),
        'U8': ('DX= 90723 ó 90722', 'azul_claro', 7, False),
        'V8': ('DX= 90681', 'azul_claro', 7, False),
        'W8': ('DX= 99199.17 ó 99199.19', 'azul_claro', 7, False),
        'X8': ('DX= 99199.17 ó 99199.19', 'azul_claro', 7, False),
        'Y8': ('DX = 85018 ó 85018.01 ó 85031', 'azul_claro', 7, False),
    ...
    _apply_row_borders(ws, [5, 6, 7, 8], 'B', 'Z', border_negro)
...
def _add_titles(ws, style_mgr):
    ...
    titles = [
        ...
        ('B4', 'SEGUIMIENTO NOMINAL:MC-02.01: PORCENTAJE DE NIÑAS Y NIÑOS MENORES DE 12 MESES DE EDAD PROCEDENTES DE DISTRITOS DE QUINTILES 1 Y 2 DE POBREZA DEPARTAMENTAL, QUE RECIBIERON EL PAQUETE INTEGRADO DE SERVICIOS', 12, True, '000000'),
    ]
...
def _write_data(ws, results, style_mgr):
    ...
    left_align_cols = {32,34}
    # Columnas con check/x marks
    check_cols = {13,14,15,18,19,20,21,22,23,24,25,26}
    # Columnas con check/x marks validador
    check_cols_validador = {16,17}
    # Columnas de sub-indicadores
    sub_indicator_cols = {18}
    ...
    for row_idx, record in enumerate(results, start=10):
        for col_idx, value in enumerate(record.values(), start=2):
            ...
            if col_idx == 27:  # Columna INDICADOR
