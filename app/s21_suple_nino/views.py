...
from .queries import obtener_velocimetro_s21_suple_nino, obtener_grafico_mensual_s21_suple_nino, obtener_variables_s21_suple_nino, obtener_variables_detallado_s21_suple_nino, obtener_grafico_por_redes_s21_suple_nino
from .queries import obtener_grafico_por_microredes_s21_suple_nino, obtener_grafico_por_establecimientos_s21_suple_nino
from .queries import obtener_seguimiento_s21_suple_nino
...
######################################
## VELOCIMETRO
def process_velocimetro_s21_suple_nino(resultados_velocimetro_s21_suple_nino: List[Dict]) -> Dict[str, List]:
    """
    ...
    """
    # Validar entrada
    if not resultados_velocimetro_s21_suple_nino or len(resultados_velocimetro_s21_suple_nino) == 0:
    ...
    row = resultados_velocimetro_s21_suple_nino[0]
...
def obtener_resumen_indicador_s21_suple_nino(anio, mes_inicio, mes_fin, red, microred, establecimiento, provincia=None, distrito=None):
    """
    Obtiene un resumen detallado del indicador 
    """
    datos_base = obtener_velocimetro_s21_suple_nino(anio, mes_inicio, mes_fin, red, microred, establecimiento, provincia, distrito)
...
def process_avance_mensual_s21_suple_nino(resultados_avance_mensual_s21_suple_nino: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_avance_mensual_s21_suple_nino):
        try:
...
## GRAFICO VARIABLES 
def process_variables_s21_suple_nino(resultados_variables_s21_suple_nino: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_variables_s21_suple_nino):
        try:
            # Verifica que el diccionario tenga las claves necesarias
            required_keys = {'den_variable','num_hierro4m','avance_hierro4m','num_hb6m','avance_hb6m'}
...
def process_variables_detallado_s21_suple_nino(resultados_variables_detallado_s21_suple_nino: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_variables_detallado_s21_suple_nino):
        try:
            # Verifica que el diccionario tenga las claves necesarias
            ...
            'd_num_hierro4m','d_avance_hierro4m','d_num_hb6m','d_avance_hb6m'}
...
def process_grafico_por_redes_s21_suple_nino(resultados_grafico_por_redes_s21_suple_nino: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_grafico_por_redes_s21_suple_nino):
        try:
            # Verifica que el diccionario tenga las claves necesarias
...
def process_grafico_por_microredes_s21_suple_nino(resultados_grafico_por_microredes_s21_suple_nino: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_grafico_por_microredes_s21_suple_nino):
        try:
            # Verifica que el diccionario tenga las claves necesarias
...
def process_grafico_por_establecimientos_s21_suple_nino(resultados_grafico_por_establecimientos_s21_suple_nino: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_grafico_por_establecimientos_s21_suple_nino):
        try:
            # Verifica que el diccionario tenga las claves necesarias
...
def index_s21_suple_nino(request):
    """
    ...
    if request.headers.get('x-requested-with') == 'XMLHttpRequest':
        try:
            ...
            resultados_velocimetro_s21_suple_nino = obtener_velocimetro_s21_suple_nino(
                anio=anio,
            ...
            resumen_s21_suple_nino = obtener_resumen_indicador_s21_suple_nino(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,
                mes_fin=mes_seleccionado_fin,
                red=red_seleccionada,
            ...
            resultados_grafico_mensual_s21_suple_nino = obtener_grafico_mensual_s21_suple_nino(
                anio=anio,
            ...
            resultados_variables_s21_suple_nino = obtener_variables_s21_suple_nino(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,
            ...
            resultados_variables_detallado_s21_suple_nino = obtener_variables_detallado_s21_suple_nino(
                anio=anio,
            ...
            resultados_grafico_por_redes_s21_suple_nino = obtener_grafico_por_redes_s21_suple_nino(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,  # Usa el mes de inicio seleccionado
                mes_fin=mes_seleccionado_fin,        # Usa el mes de fin seleccionado
                red=red_seleccionada,
            ...
            resultados_grafico_por_microredes_s21_suple_nino = obtener_grafico_por_microredes_s21_suple_nino(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,  # Usa el mes de inicio seleccionado
                mes_fin=mes_seleccionado_fin,        # Usa el mes de fin seleccionado
                red=red_seleccionada,
            ...
            resultados_grafico_por_establecimientos_s21_suple_nino = obtener_grafico_por_establecimientos_s21_suple_nino(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,  # Usa el mes de inicio seleccionado
                mes_fin=mes_seleccionado_fin,        # Usa el mes de fin seleccionado
                red=red_seleccionada,
            ...
            data = {
               **process_velocimetro_s21_suple_nino(resultados_velocimetro_s21_suple_nino),
               **process_avance_mensual_s21_suple_nino(resultados_grafico_mensual_s21_suple_nino),
               **process_variables_s21_suple_nino(resultados_variables_s21_suple_nino),
               **process_variables_detallado_s21_suple_nino(resultados_variables_detallado_s21_suple_nino),
               **process_grafico_por_redes_s21_suple_nino(resultados_grafico_por_redes_s21_suple_nino),
               **process_grafico_por_microredes_s21_suple_nino(resultados_grafico_por_microredes_s21_suple_nino),
               **process_grafico_por_establecimientos_s21_suple_nino(resultados_grafico_por_establecimientos_s21_suple_nino)
            }

            # Agregar datos del resumen a la respuesta
            if resumen_s21_suple_nino:
                data['r_numerador_resumen'] = resumen_s21_suple_nino['numerador']
                data['r_denominador_resumen'] = resumen_s21_suple_nino['denominador']
                data['r_avance_resumen'] = resumen_s21_suple_nino['avance']
                data['r_brecha'] = resumen_s21_suple_nino['brecha']
                data['r_clasificacion'] = resumen_s21_suple_nino['clasificacion']
                data['r_color'] = resumen_s21_suple_nino['color']
                data['r_icono'] = resumen_s21_suple_nino['icono']
    ...
    return render(request, 's21_suple_nino/index_s21_suple_nino.html', context)
...
def get_establecimientos_s21_suple_nino_h(request, establecimiento_id):
    """
    ...
    return render(request, 's21_suple_nino/establecimientos_h.html', context)


def p_microredes_establec_s21_suple_nino_h(request):
    """
    ...
    return render(request, 's21_suple_nino/partials/p_microredes_establec_h.html', context)


def p_establecimientos_s21_suple_nino_h(request):
    """
    ...
    return render(request, 's21_suple_nino/partials/p_establecimientos_h.html', context)


def p_distritos_s21_suple_nino_h(request):
    """
    ...
    return render(request, 's21_suple_nino/partials/p_distritos.html', context)
...
def get_redes_s21_suple_nino(request, redes_id):
    """
    Renderiza el formulario de reportes por REDES.
    """
    context = _get_context_base_con_filtros(include_meses=True)
    return render(request, 's21_suple_nino/components/salud/redes.html', context)


def get_microredes_s21_suple_nino(request, microredes_id):
    """
    ...
    return render(request, 's21_suple_nino/components/salud/microredes.html', context)


def get_establecimientos_s21_suple_nino(request, establecimiento_id):
    ...
    return render(request, 's21_suple_nino/components/salud/establecimientos.html', context)
...
def p_microredes_s21_suple_nino(request):
    """
    ...
    return render(request, 's21_suple_nino/partials/p_microredes.html', context)


def p_microredes_establec_s21_suple_nino(request):
    """
    ...
    return render(request, 's21_suple_nino/partials/p_microredes_establec.html', {
        'microredes': microredes,
        'red': red,
    })
...
# ============================================
def p_establecimientos_s21_suple_nino(request):
    """
    ...
    return render(request, 's21_suple_nino/partials/p_establecimientos.html', {
...
def get_provincias_s21_suple_nino(request, provincia_id):
    provincias = (
    ...
    return render(request, 's21_suple_nino/components/municipio/provincias.html', context)

## SEGUIMIENTO POR DISTRITOS
def get_distritos_s21_suple_nino(request, distrito_id):
    provincias = (
                MAESTRO_HIS_ESTABLECIMIENTO
                .objects.filter(Descripcion_Sector='GOBIERNO REGIONAL')
                .annotate(ubigueo_filtrado=Substr('Ubigueo_Establecimiento', 1, 4))
    ...
    return render(request, 's21_suple_nino/components/municipio/distritos.html', context)


def p_distrito_s21_suple_nino(request):
...
# Anchos de columnas
COLUMN_WIDTHS = {
    'A': 1, 'B': 9, 'C': 20, 'D': 9, 'E': 9, 'F': 8, 'G': 30, 'H': 8,
    'I': 9, 'J': 5, 'K': 5, 'L': 5, 'M':5, 'N': 5, 'O': 9, 'P': 10,'Q': 5,
    'R': 10,'S': 8, 'T': 5, 'U':12, 'V':5, 'W':10, 'X':20, 'Y':10, 'Z':20,'AA':10, 
    'AB':25
}
...
MERGE_CELLS_CONFIG = [
    ...
    ('B6', 'O6'), ('P6', 'Q6'),('R6','T6'), 
    # Fila 7
    ('B7','E7'),('F7','N7'),('P7','Q7'),('R7','T7'),
    # Fila 8
    ('B8','J8'),('K8','N8'),('P8','Q8'),('R8','T8'),
    # Columnas 
    ('O7','O8'),('U6','V8')
]
...
class RptSupleNino(BaseExcelReportView):
    """Reporte de captación de gestantes."""
    
    filename = "rpt_s21_suple_nino.xlsx"
    ...
    def get_data(self, params):
        return obtener_seguimiento_s21_suple_nino(
...
class RptSupleNinoMicroRed(BaseExcelReportView):
    """Reporte de población por microred."""
    
    filename = "rpt_s21_suple_nino_microred.xlsx"
    sheet_name = "Seguimiento"
...
class RptSupleNinoEstablec(BaseExcelReportView):
    """Reporte de población por establecimiento."""
    
    filename = "rpt_s21_suple_nino_establecimiento.xlsx"
    sheet_name = "Seguimiento"
...
def _style_header_sections(ws, style_mgr):
    ...
    sections_config = {
        ...
        'P5': ('Iniciaron la suplementación preventiva a los 4 meses de edad, y cuentan con dosaje de hemoglobina', 'naranja_claro', 10, True),
        # Fila 6: B6:M6, N6:S6, T6:Y6, Z6:AA6 son rangos combinados
        'B6': ('N° de niñas y niños de 6 meses de edad del departamento, registrados en el padrón nominal (con DNI o CNV en línea), en el mes de medición', 'gray', 10, True),
        'P6': ('A los 4 meses de edad', 'gray', 10, True),
        'R6': ('A los 6 meses de edad', 'gray', 10, True),
        ...
        'P7': ('Reciben un frasco de hierro', 'plomo_claro', 7, False),
        'R7': ('Cuentan con dosaje de hemoglobina', 'plomo_claro', 7, False),
        ...
        'K8': ('VALIDADORES', 'azul_claro', 7, False),
        'P8': ('DX = 99199.17', 'azul_claro', 7, False),      
        'R8': ('DX = 85018 ó 85018.01 ó 85031', 'azul_claro', 7, False),
    ...
    _apply_row_borders(ws, [5, 6, 7, 8], 'B', 'V', border_negro)
...
def _write_data(ws, results, style_mgr):
    ...
    left_align_cols = {7, 26, 28}
    # Columnas con check/x marks
    check_cols = {11,12,13,14,17,20}
    # Columnas de sub-indicadores
    sub_indicator_cols = {15}
    ...
    for row_idx, record in enumerate(results, start=10):
        for col_idx, value in enumerate(record.values(), start=2):
            ...
            if col_idx == 21:  # Columna INDICADOR
