...
from .queries import obtener_velocimetro_s32_adole_sin_anemia, obtener_grafico_mensual_s32_adole_sin_anemia, obtener_variables_s32_adole_sin_anemia, obtener_variables_detallado_s32_adole_sin_anemia, obtener_grafico_por_redes_s32_adole_sin_anemia
from .queries import obtener_grafico_por_microredes_s32_adole_sin_anemia, obtener_grafico_por_establecimientos_s32_adole_sin_anemia
from .queries import obtener_seguimiento_s32_adole_sin_anemia
...
######################################
## VELOCIMETRO
def process_velocimetro_s32_adole_sin_anemia(resultados_velocimetro_s32_adole_sin_anemia: List[Dict]) -> Dict[str, List]:
    """
    ...
    """
    # Validar entrada
    if not resultados_velocimetro_s32_adole_sin_anemia or len(resultados_velocimetro_s32_adole_sin_anemia) == 0:
    ...
    row = resultados_velocimetro_s32_adole_sin_anemia[0]
...
def obtener_resumen_indicador_s32_adole_sin_anemia(anio, mes_inicio, mes_fin, red, microred, establecimiento, provincia=None, distrito=None):
    """
    Obtiene un resumen detallado del indicador 
    """
    datos_base = obtener_velocimetro_s32_adole_sin_anemia(anio, mes_inicio, mes_fin, red, microred, establecimiento, provincia, distrito)
...
def process_avance_mensual_s32_adole_sin_anemia(resultados_avance_mensual_s32_adole_sin_anemia: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_avance_mensual_s32_adole_sin_anemia):
        try:
...
## GRAFICO VARIABLES 
def process_variables_s32_adole_sin_anemia(resultados_variables_s32_adole_sin_anemia: List[Dict]) -> Dict[str, List]:
    ...
    data = {
        ...
        'avance_num_suple': [],
        'num_consejeria': [],
        'avance_num_consejeria': [],
        'num_con_ali': [],
        'avance_num_con_ali': [],
        'num_con_nutri': [],
        'avance_num_con_nutri': [],
        'num_dosaje': [],
        'avance_num_dosaje': []
    }
    for index, row in enumerate(resultados_variables_s32_adole_sin_anemia):
        try:
            # Verifica que el diccionario tenga las claves necesarias
            required_keys = {'den_variable','num_suple','avance_num_suple','num_consejeria','avance_num_consejeria','num_con_ali','avance_num_con_ali','num_con_nutri','avance_num_con_nutri','num_dosaje','avance_num_dosaje'}
            ...
            num_suple = row['num_suple']
            avance_num_suple = row['avance_num_suple']
            num_consejeria = row['num_consejeria']
            avance_num_consejeria = row['avance_num_consejeria']
            num_con_ali = row['num_con_ali']
            avance_num_con_ali = row['avance_num_con_ali']
            num_con_nutri = row['num_con_nutri']
            avance_num_con_nutri = row['avance_num_con_nutri']
            num_dosaje = row['num_dosaje']
            avance_num_dosaje = row['avance_num_dosaje']
            
            # Agrega los valores a la lista
            data['den_variable'].append(den_variable)
            data['num_suple'].append(num_suple)
            data['avance_num_suple'].append(avance_num_suple)
            data['num_consejeria'].append(num_consejeria)
            data['avance_num_consejeria'].append(avance_num_consejeria)
            data['num_con_ali'].append(num_con_ali)
            data['avance_num_con_ali'].append(avance_num_con_ali)
            data['num_con_nutri'].append(num_con_nutri)
            data['avance_num_con_nutri'].append(avance_num_con_nutri)
            data['num_dosaje'].append(num_dosaje)
            data['avance_num_dosaje'].append(avance_num_dosaje)
...
def process_variables_detallado_s32_adole_sin_anemia(resultados_variables_detallado_s32_adole_sin_anemia: List[Dict]) -> Dict[str, List]:
    ...
    data = {
        ...
        'd_avance_num_suple': [],
        'd_num_consejeria': [],
        'd_avance_num_consejeria': [],
        'd_num_con_ali': [],
        'd_avance_num_con_ali': [],
        'd_num_con_nutri': [],
        'd_avance_num_con_nutri': [],
        'd_num_dosaje': [],
        'd_avance_num_dosaje': []
    }
    for index, row in enumerate(resultados_variables_detallado_s32_adole_sin_anemia):
        try:
            # Verifica que el diccionario tenga las claves necesarias
            ...
            d_avance_num_consejeria = row['d_avance_num_consejeria']
            d_num_con_ali = row['d_num_con_ali']
            d_avance_num_con_ali = row['d_avance_num_con_ali']
            d_num_con_nutri = row['d_num_con_nutri']
            d_avance_num_con_nutri = row['d_avance_num_con_nutri']
            d_num_dosaje = row['d_num_dosaje']
            d_avance_num_dosaje = row['d_avance_num_dosaje']
            ...
            data['d_avance_num_consejeria'].append(d_avance_num_consejeria)
            data['d_num_con_ali'].append(d_num_con_ali)
            data['d_avance_num_con_ali'].append(d_avance_num_con_ali)
            data['d_num_con_nutri'].append(d_num_con_nutri)
            data['d_avance_num_con_nutri'].append(d_avance_num_con_nutri)
            data['d_num_dosaje'].append(d_num_dosaje)
            data['d_avance_num_dosaje'].append(d_avance_num_dosaje)
...
def process_grafico_por_redes_s32_adole_sin_anemia(resultados_grafico_por_redes_s32_adole_sin_anemia: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_grafico_por_redes_s32_adole_sin_anemia):
        try:
            # Verifica que el diccionario tenga las claves necesarias
...
def process_grafico_por_microredes_s32_adole_sin_anemia(resultados_grafico_por_microredes_s32_adole_sin_anemia: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_grafico_por_microredes_s32_adole_sin_anemia):
        try:
            # Verifica que el diccionario tenga las claves necesarias
...
def process_grafico_por_establecimientos_s32_adole_sin_anemia(resultados_grafico_por_establecimientos_s32_adole_sin_anemia: List[Dict]) -> Dict[str, List]:
    ...
    for index, row in enumerate(resultados_grafico_por_establecimientos_s32_adole_sin_anemia):
        try:
            # Verifica que el diccionario tenga las claves necesarias
...
def index_s32_adole_sin_anemia(request):
    """
    ...
    if request.headers.get('x-requested-with') == 'XMLHttpRequest':
        try:
            ...
            resultados_velocimetro_s32_adole_sin_anemia = obtener_velocimetro_s32_adole_sin_anemia(
                anio=anio,
            ...
            resumen_s32_adole_sin_anemia = obtener_resumen_indicador_s32_adole_sin_anemia(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,
                mes_fin=mes_seleccionado_fin,
                red=red_seleccionada,
            ...
            resultados_grafico_mensual_s32_adole_sin_anemia = obtener_grafico_mensual_s32_adole_sin_anemia(
                anio=anio,
            ...
            resultados_variables_s32_adole_sin_anemia = obtener_variables_s32_adole_sin_anemia(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,
            ...
            resultados_variables_detallado_s32_adole_sin_anemia = obtener_variables_detallado_s32_adole_sin_anemia(
                anio=anio,
            ...
            resultados_grafico_por_redes_s32_adole_sin_anemia = obtener_grafico_por_redes_s32_adole_sin_anemia(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,  # Usa el mes de inicio seleccionado
                mes_fin=mes_seleccionado_fin,        # Usa el mes de fin seleccionado
                red=red_seleccionada,
            ...
            resultados_grafico_por_microredes_s32_adole_sin_anemia = obtener_grafico_por_microredes_s32_adole_sin_anemia(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,  # Usa el mes de inicio seleccionado
                mes_fin=mes_seleccionado_fin,        # Usa el mes de fin seleccionado
                red=red_seleccionada,
            ...
            resultados_grafico_por_establecimientos_s32_adole_sin_anemia = obtener_grafico_por_establecimientos_s32_adole_sin_anemia(
                anio=anio,
                mes_inicio=mes_seleccionado_inicio,  # Usa el mes de inicio seleccionado
                mes_fin=mes_seleccionado_fin,        # Usa el mes de fin seleccionado
                red=red_seleccionada,
            ...
            data = {
               **process_velocimetro_s32_adole_sin_anemia(resultados_velocimetro_s32_adole_sin_anemia),
               **process_avance_mensual_s32_adole_sin_anemia(resultados_grafico_mensual_s32_adole_sin_anemia),
               **process_variables_s32_adole_sin_anemia(resultados_variables_s32_adole_sin_anemia),
               **process_variables_detallado_s32_adole_sin_anemia(resultados_variables_detallado_s32_adole_sin_anemia),
               **process_grafico_por_redes_s32_adole_sin_anemia(resultados_grafico_por_redes_s32_adole_sin_anemia),
               **process_grafico_por_microredes_s32_adole_sin_anemia(resultados_grafico_por_microredes_s32_adole_sin_anemia),
               **process_grafico_por_establecimientos_s32_adole_sin_anemia(resultados_grafico_por_establecimientos_s32_adole_sin_anemia)
            }

            # Agregar datos del resumen a la respuesta
            if resumen_s32_adole_sin_anemia:
                data['r_numerador_resumen'] = resumen_s32_adole_sin_anemia['numerador']
                data['r_denominador_resumen'] = resumen_s32_adole_sin_anemia['denominador']
                data['r_avance_resumen'] = resumen_s32_adole_sin_anemia['avance']
                data['r_brecha'] = resumen_s32_adole_sin_anemia['brecha']
                data['r_clasificacion'] = resumen_s32_adole_sin_anemia['clasificacion']
                data['r_color'] = resumen_s32_adole_sin_anemia['color']
                data['r_icono'] = resumen_s32_adole_sin_anemia['icono']
    ...
    return render(request, 's32_adole_sin_anemia/index_s32_adole_sin_anemia.html', context)
...
def get_establecimientos_s32_adole_sin_anemia_h(request, establecimiento_id):
    """
    ...
    return render(request, 's32_adole_sin_anemia/establecimientos_h.html', context)


def p_microredes_establec_s32_adole_sin_anemia_h(request):
    """
    ...
    return render(request, 's32_adole_sin_anemia/partials/p_microredes_establec_h.html', context)


def p_establecimientos_s32_adole_sin_anemia_h(request):
    """
    ...
    return render(request, 's32_adole_sin_anemia/partials/p_establecimientos_h.html', context)


def p_distritos_s32_adole_sin_anemia_h(request):
    """
    ...
    return render(request, 's32_adole_sin_anemia/partials/p_distritos.html', context)
...
def get_redes_s32_adole_sin_anemia(request, redes_id):
    """
    Renderiza el formulario de reportes por REDES.
    """
    context = _get_context_base_con_filtros(include_meses=True)
    return render(request, 's32_adole_sin_anemia/components/salud/redes.html', context)


def get_microredes_s32_adole_sin_anemia(request, microredes_id):
    """
    ...
    return render(request, 's32_adole_sin_anemia/components/salud/microredes.html', context)


def get_establecimientos_s32_adole_sin_anemia(request, establecimiento_id):
    ...
    return render(request, 's32_adole_sin_anemia/components/salud/establecimientos.html', context)
...
def p_microredes_s32_adole_sin_anemia(request):
    """
    ...
    return render(request, 's32_adole_sin_anemia/partials/p_microredes.html', context)


def p_microredes_establec_s32_adole_sin_anemia(request):
    """
    ...
    return render(request, 's32_adole_sin_anemia/partials/p_microredes_establec.html', {
        'microredes': microredes,
        'red': red,
    })
...
# ============================================
def p_establecimientos_s32_adole_sin_anemia(request):
    """
    ...
    return render(request, 's32_adole_sin_anemia/partials/p_establecimientos.html', {
...
def get_provincias_s32_adole_sin_anemia(request, provincia_id):
    provincias = (
    ...
    return render(request, 's32_adole_sin_anemia/components/municipio/provincias.html', context)

## SEGUIMIENTO POR DISTRITOS
def get_distritos_s32_adole_sin_anemia(request, distrito_id):
    provincias = (
                MAESTRO_HIS_ESTABLECIMIENTO
                .objects.filter(Descripcion_Sector='GOBIERNO REGIONAL')
                .annotate(ubigueo_filtrado=Substr('Ubigueo_Establecimiento', 1, 4))
    ...
    return render(request, 's32_adole_sin_anemia/components/municipio/distritos.html', context)


def p_distrito_s32_adole_sin_anemia(request):
...
class RptAdoleSinAnemia(BaseExcelReportView):
    """Reporte de captación de gestantes."""
    
    filename = "rpt_s32_adole_sin_anemia.xlsx"
    ...
    def get_data(self, params):
        return obtener_seguimiento_s32_adole_sin_anemia(
...
class RptAdoleSinAnemiaMicroRed(BaseExcelReportView):
    """Reporte de población por microred."""
    
    filename = "rpt_s32_adole_sin_anemia_microred.xlsx"
    sheet_name = "Seguimiento"
...
class RptAdoleSinAnemiaEstablec(BaseExcelReportView):
    """Reporte de población por establecimiento."""
    
    filename = "rpt_s32_adole_sin_anemia_establecimiento.xlsx"
    sheet_name = "Seguimiento"
